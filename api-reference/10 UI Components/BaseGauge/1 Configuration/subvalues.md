...
You can obtain and change the subvalues at runtime. In order to do this, use the [subvalues()](/api-reference/10%20UI%20Components/BaseGauge/3%20Methods/subvalues().md '{basewidgetpath}/Methods#subvalues') and [subvalues(subvalues)](/api-reference/10%20UI%20Components/BaseGauge/3%20Methods/subvalues().md '{basewidgetpath}/Methods#subvalues'subvalues) methods. Note that in that case, you need to initialize the **subvalues** property at least with an empty array.
