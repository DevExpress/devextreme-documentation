...
<table class="dx-table">
    ...
    <tr>
        ...
        <td>Specify a container for the component. The component occupies the container area on initialization. If a container's size changes, the component's size does not change. If you want to update the size, call the <a href="https://js.devexpress.com/Documentation/ApiReference/UI_Components/dxSparkline/Methods/#render">render</a> method.</td>
    </tr>
</table>
