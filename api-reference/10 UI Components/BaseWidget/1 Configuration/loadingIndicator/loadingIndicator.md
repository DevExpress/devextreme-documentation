...
To enable the automatic loading indicator, set the [enabled](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/loadingIndicator/enabled.md '{basewidgetpath}/Configuration/loadingIndicator/#enabled') option to **true**.
