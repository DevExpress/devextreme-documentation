...
[note]In a right-to-left representation, SVG elements have the <a href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/direction" target="_blank">direction</a> attribute with the *rtl* value. This might cause problems when rendering left-to-right texts. Use this property if you have only right-to-left texts.