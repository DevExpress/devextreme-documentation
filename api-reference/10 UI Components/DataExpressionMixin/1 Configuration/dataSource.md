...
#include common-dataSource-description with {
    ...
    dataSource_items_note: "- Do not specify the [items](/api-reference/10%20UI%20Widgets/DataExpressionMixin/1%20Configuration/items '/api-reference/10%20UI%20Components/CollectionWidget/1%20Configuration/items '{basewidgetpath}/Configuration/items/'') property if you specified the **dataSource**, and vice versa."
}