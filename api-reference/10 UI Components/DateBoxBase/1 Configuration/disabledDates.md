...
---
##### shortDescription
Specifies dates that users cannot select. Applies only if [pickerType](/Documentation/ApiReference/UI_Components/dx{WidgetName}/Configuration/#pickerType) is *"calendar"*.
