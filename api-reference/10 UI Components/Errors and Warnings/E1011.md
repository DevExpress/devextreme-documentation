...
---
Pass the function implementing the **remove(key)** method to the [remove](/api-reference/30%20Data%20Layer/CustomStore/1%20Configuration/remove.md '/Documentation/ApiReference/Data_Layer/CustomStore/Configuration/#remove') property of the **CustomStore**.