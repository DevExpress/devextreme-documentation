...
#include common-dataSource-description with {
    widget_works_with: "The DataGrid works with collections of objects. We recommend you to use a plain object in data (no circulars, no prototypes etc.). The DataGird uses **JSON.stringify** and other recursive methods. Circular object references can crash native recursive algorithms (such as serializers) with stack overflows.",
