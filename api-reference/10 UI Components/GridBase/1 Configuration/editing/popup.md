...
---
You can specify any [Popup option](/api-reference/10%20UI%20Components/dxPopup/1%20Configuration '/Documentation/ApiReference/UI_Components/dxPopup/Configuration/') in this object, but note that the following options override the **{WidgetName}**'s internal logic:
...
The popup always contains a form whose items are used for editing. Use the [form](/api-reference/10%20UI%20Components/GridBase/1%20Configuration/editing/form.md '{basewidgetpath}/Configuration/editing/#form') option to customize the form's items.
