...
---
You can specify any [Popup option](/api-reference/10%20UI%20Widgets/dxPopup/1%20Configuration '/Documentation/ApiReference/UI_Components/dxPopup/Configuration/') in this object, but note that the following options override the **{WidgetName}**'s internal logic:
