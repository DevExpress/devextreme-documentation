...
---
See the [FilterBuilder configuration](/api-reference/10%20UI%20Components/dxFilterBuilder/1%20Configuration '/Documentation/ApiReference/UI_Components/dxFilterBuilder/Configuration/') for options that you can specify in this object.
