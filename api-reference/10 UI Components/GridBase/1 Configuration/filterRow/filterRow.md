...
[note] If you use [grouped](/Documentation/Guide/UI_Components/Lookup/Enable_Grouping/) data structure to display data in a lookup column, the **All** item in the filter row is not displayed.
