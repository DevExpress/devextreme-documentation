...
---
##### shortDescription
The index of the column that contains the focused data cell. This index is taken from the [columns](/api-reference/10%20UI%20Components/GridBase/1%20Configuration/columns '{basewidgetpath}/Configuration/columns/') array.
