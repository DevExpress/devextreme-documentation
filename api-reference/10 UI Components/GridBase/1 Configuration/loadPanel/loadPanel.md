...
Since the load panel is, in fact, the DevExtreme [LoadPanel](/concepts/05%20UI%20Components/LoadPanel/00%20Overview.md '/Documentation/Guide/UI_Components/LoadPanel/Overview/') UI component, the **loadPanel** object can contain any options of this UI component along with options described here.
