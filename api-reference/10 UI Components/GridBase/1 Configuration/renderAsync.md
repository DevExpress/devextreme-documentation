...
---
This property can affect the DataGrid templates rendering as follows:

- If you need to render templates in a table that is already attached to the DOM, set the property to **true** or **undefined**  
- If the templates should render in a table that is not yet attached to the DOM, set the property to **false**
