...
The row's original position (when [paging]({basewidgetpath}/Configuration/paging/) is enabled, the row's original position in the active page). If the row is dragged from another UI component, this value is **-1**.
...
The row's dropped position (when [paging]({basewidgetpath}/Configuration/paging/) is enabled, the row's dropped position in the active page). If the row is dragged into another UI component, this value is **-1**.
