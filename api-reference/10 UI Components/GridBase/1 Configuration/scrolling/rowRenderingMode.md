...
Note that the **rowRenderingMode** property value is 'virtual' and cannot be changed if you set the **scrolling**.[mode](/api-reference/10%20UI%20Components/dxDataGrid/1%20Configuration/scrolling/mode.md '{basewidgetpath}/Configuration/scrolling/#mode') property to 'virtual' or 'infinite'.
