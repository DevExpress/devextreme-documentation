...
---
To access a data row by its key, you should specify the field that provides keys in the [data source](/api-reference/10%20UI%20Components/GridBase/1%20Configuration/dataSource.md '{basewidgetpath}/Configuration/#dataSource'). If no key was specified, the whole data object is considered the key.

#####See Also#####
#include common-link-callmethods
- [isAdaptiveDetailRowExpanded(key)](/api-reference/10%20UI%20Components/GridBase/3%20Methods/isAdaptiveDetailRowExpanded(key).md '{basewidgetpath}/Methods/#isAdaptiveDetailRowExpandedkey')
