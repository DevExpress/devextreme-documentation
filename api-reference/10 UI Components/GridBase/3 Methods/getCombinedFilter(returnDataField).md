...
To learn how to obtain all filtered and sorted rows of a DataGrid component with **getCombinedFilter(returnDataField)**, refer to the following example:

#include btn-open-github with {
    href: "https://github.com/DevExpress-Examples/devextreme-datagrid-get-all-filtered-data"
}

To learn how to filter a Chart component's series based on a DataGrid component's filters with **getCombinedFilter(returnDataField)**, refer to the following example:
