...
---
The **dxItem** component defines custom markup for items in layout and collection UI components. **dxItem** has different options depending on the UI component where it is used. For a full list of them, see the **items** property description in a specific UI component's API Reference.
...
[note]**dxItem** elements are ignored when the **dataSource** property is defined.