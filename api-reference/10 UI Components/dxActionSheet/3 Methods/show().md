...
---
As an alternative, use the [toggle(true)](/api-reference/10%20UI%20Widgets/dxActionSheet/3%20Methods/toggle(showing).md '/Documentation/ApiReference/UI_Components/dxActionSheet/Methods/#toggleshowing') method.
