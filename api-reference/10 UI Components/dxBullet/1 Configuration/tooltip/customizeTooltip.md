...
<table class="dx-table full-width">
    ...
    <tr>
        ...
        <td>The primary bullet value with applied formatting if the <a href="/Documentation/ApiReference/UI_Components/dxBullet/Configuration/tooltip/#format">format</a> property is specified.</td>
    </tr>
    <tr>
