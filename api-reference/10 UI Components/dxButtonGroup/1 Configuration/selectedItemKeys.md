...
---
The data field that provides the keys can be specified using the [keyExpr](/api-reference/10%20UI%20Components/dxButtonGroup/1%20Configuration/keyExpr.md '/Documentation/ApiReference/UI_Components/dxButtonGroup/Configuration/#keyExpr') option.
