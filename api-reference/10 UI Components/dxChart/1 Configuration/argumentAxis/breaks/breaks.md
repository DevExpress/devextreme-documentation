...
---
##### shortDescription
Declares a scale break collection. Applies only if the axis' [type](/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/#type) is *"continuous"* or *"logarithmic"*.
