...
#####See Also#####
- **argumentAxis**.[constantLines[]](/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/constantLines/) - configures individual constant lines. Overrides the options of the **argumentAxis**.**constantLineStyle** object, which is described here.
