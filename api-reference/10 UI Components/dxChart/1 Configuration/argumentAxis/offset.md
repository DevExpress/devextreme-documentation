...
---
Negative numbers shift the axis position to the top, positive numbers - to the bottom. If the [rotated](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/rotated.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/#rotated') option is enabled, negative numbers will shift the axis position to the left, and positive numbers - to the right.
