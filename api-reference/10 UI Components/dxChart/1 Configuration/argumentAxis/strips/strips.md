...
notUsedInTheme: 
inheritsType: viz/chart:ArgumentAxisStrips
---
---
##### shortDescription
...
#####See Also#####
- **argumentAxis**.[stripStyle](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/commonAxisSettings/stripStyle '/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/stripStyle/') - specifies the appearance of those strips that belong to the argument axis.
- **commonAxisSettings**.[stripStyle](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/commonAxisSettings/stripStyle '/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/stripStyle/') - specifies the appearance of all strips in the UI component.