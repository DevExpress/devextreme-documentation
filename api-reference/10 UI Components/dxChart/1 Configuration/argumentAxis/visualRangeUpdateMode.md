...
- *"shift"*    
**visualRange** moves to the end of the data range or [wholeRange](/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/wholeRange/) if defined. The range length does not change.
