...
---
##### shortDescription
Controls the width of bars in the UI component. Applies only to bar-like series and when the [equalBarWidth](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/equalBarWidth.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/#equalBarWidth') option is **true**.
