...
---
[note] Unless the [rotated](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/rotated.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/#rotated') option is set to **true**, the argument axis is horizontal and the value axis is vertical.
