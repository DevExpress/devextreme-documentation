...
If you need to define a background color for the Chart, you can use the [elementAttr](/Documentation/ApiReference/UI_Components/dxChart/Configuration/#elementAttr) property to assign a custom CSS class with a defined background color.
