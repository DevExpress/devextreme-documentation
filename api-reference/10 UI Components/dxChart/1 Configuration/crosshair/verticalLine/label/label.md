...
#####See Also#####
- **crosshair**.**horizontalLine**.[label](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/crosshair/horizontalLine/label '/Documentation/ApiReference/UI_Components/dxChart/Configuration/crosshair/horizontalLine/label/') - configures the label that belongs to the horizontal crosshair line.