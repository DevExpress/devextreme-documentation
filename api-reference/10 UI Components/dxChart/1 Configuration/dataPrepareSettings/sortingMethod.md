...
[note]When the [argumentType](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/argumentAxis/argumentType.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/#argumentType') is *'numeric'* or *'datetime'*, the **sortingMethod** property does not affect argument axis. If you want to display arguments in descending order, enable the [inverted](/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/#inverted) property.
...
The following code sorts string arguments in the alphabetical order:
