...
Normally, the *height* and *width* from this formula equal the size of the UI component container. However, when several [panes](/Documentation/ApiReference/UI_Components/dxChart/Configuration/panes/) are used in the UI component, the *height* and *width* equal the pane size.