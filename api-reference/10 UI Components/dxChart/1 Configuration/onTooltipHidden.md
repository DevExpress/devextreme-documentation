---
id: dxChart.Options.onTooltipHidden
type: function(e)
---
---
##### shortDescription
...
##### param(e): viz/chart:TooltipHiddenEvent
...
The series point whose tooltip is hidden; described in the [Point](/api-reference/10%20UI%20Components/dxChart/7%20Chart%20Elements/Point '{basewidgetpath}/Chart_Elements/Point/') section.
