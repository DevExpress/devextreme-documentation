...
Each object in the **breaks** array configures a single scale break. We recommend that a scale break range exceeds the tick interval twice. Otherwise, the scale break might not be visible.
