...
#####See Also#####
- **valueAxis**.[constantLines[]](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/valueAxis/constantLines/) - configures individual constant lines. Overrides the properties of the **valueAxis**.**constantLineStyle** object, which is described here.
