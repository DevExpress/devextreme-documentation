...
[note]In many cases, zooming is useless without scrolling, and vice versa. Hence, when enabling the zooming capability in your chart, consider [enabling the scrolling capability](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/scrollingMode.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/#scrollingMode') as well.
...
- **Axis**.[visualRange(visualRange)](/api-reference/10%20UI%20Components/dxChart/7%20Chart%20Elements/Axis/3%20Methods/visualRange(visualRange).md '/Documentation/ApiReference/UI_Components/dxChart/Chart_Elements/Axis/Methods/#visualRangevisualRange')
