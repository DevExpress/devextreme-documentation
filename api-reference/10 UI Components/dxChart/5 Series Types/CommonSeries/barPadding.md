...
[note] Bar and padding widths depend on the allocated space of each bar. Properties such as [ignoreEmptyPoints](/Documentation/ApiReference/UI_Components/dxChart/Configuration/commonSeriesSettings/#ignoreEmptyPoints) can affect this space.
