...
- If **valueAxis**.**label**.[position](/Documentation/ApiReference/UI_Components/dxChart/Configuration/valueAxis/label/#position) is *"outside"* and the series type is [*bar*](/Documentation/ApiReference/UI_Components/dxChart/Series_Types/BarSeries/) or [*stacked bar*](/Documentation/ApiReference/UI_Components/dxChart/Series_Types/StackedBarSeries/), the component may position labels of the highest bars inside. To ensure Chart always displays labels outside, increase [maxValueMargin](/Documentation/ApiReference/UI_Components/dxChart/Configuration/commonAxisSettings/#maxValueMargin).
