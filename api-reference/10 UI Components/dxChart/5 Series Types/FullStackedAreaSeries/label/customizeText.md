...
<table class="dx-table">
    ...
    <tr>
        <td>valueText</td>
        <td>The <i>value</i> with an applied <a href="/Documentation/ApiReference/UI_Components/dxChart/Series_Types/FullStackedAreaSeries/label/#format">format</a> and converted to string.</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>argumentText</td>
        <td>The <i>argument</i> with an applied <a href="/Documentation/ApiReference/UI_Components/dxChart/Series_Types/FullStackedAreaSeries/label/#argumentFormat">format</a> and converted to string.</td>
    </tr>
    <tr>
        <td>percent</td>
    ...
    <tr>
        <td>percentText</td>
        <td>The <i>percent</i> with an applied <a href="/Documentation/ApiReference/UI_Components/dxChart/Series_Types/FullStackedAreaSeries/label/#format">format</a> and converted to string.</td>
    </tr>
    <tr>
        <td>total</td>
    ...
    <tr>
        <td>totalText</td>
        <td>The <i>total</i> with an applied <a href="/Documentation/ApiReference/UI_Components/dxChart/Series_Types/FullStackedAreaSeries/label/#format">format</a> and converted to string.</td>
    </tr>
    <tr>
        <td>point</td>
