...
To manage large numbers of messages, prevent additional load requests, and control message rendering timing, disable **reloadOnChange**. Handle CRUD operations and [render messages](/Documentation/ApiReference/UI_Components/dxChat/Methods/#renderMessagemessage) as your needs dictate.