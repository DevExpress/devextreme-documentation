...
To get or set an option or several options for a column at runtime, use the [columnOption](/api-reference/10%20UI%20Components/GridBase/3%20Methods/columnOption(id).md '/Documentation/ApiReference/UI_Components/dxDataGrid/Methods/#columnOptionid') method with the required arguments.
