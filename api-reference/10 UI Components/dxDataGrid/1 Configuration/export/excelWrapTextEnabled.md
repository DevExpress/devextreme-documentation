...
When this option is not set, the value of the grid's [wordWrapEnabled](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/wordWrapEnabled.md '/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/#wordWrapEnabled') option is used.
