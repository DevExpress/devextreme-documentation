...
The row's [group index](/api-reference/10%20UI%20Components/dxDataGrid/1%20Configuration/columns '/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/columns/'#groupIndex). Available if **rowType** is *"group"*.
