...
- **Infinite**      
The component loads the next page once the scrollbar reaches the end of its scale. Configure **paging**.[pageSize](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/paging/#pageSize) to change page sizes. In this mode, users scroll data gradually from the first to the last page.
