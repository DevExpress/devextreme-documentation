...
---
The **textStyle** property specifies a text style that is applied to a shape/connector if the [nodes.textStyleExpr](/api-reference/10%20UI%20Widgets/dxDiagram/1%20Configuration/nodes/textStyleExpr.md '/Documentation/ApiReference/UI_Widgets/dxDiagram/Configuration/nodes/#textStyleExpr')/[edges.textStyleExpr](/api-reference/10%20UI%20Widgets/dxDiagram/1%20Configuration/edges/textStyleExpr.md '/Documentation/ApiReference/UI_Widgets/dxDiagram/Configuration/edges/#textStyleExpr') property does not provide another value.
