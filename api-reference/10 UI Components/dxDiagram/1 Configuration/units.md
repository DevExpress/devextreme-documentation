...
User interface elements display measurements in [viewUnits](/api-reference/10%20UI%20Components/dxDiagram/1%20Configuration/viewUnits.md '/api-reference/10%20UI%20Components/dxDiagram/1%20Configuration/viewUnits.md '/Documentation/ApiReference/UI_Components/dxDiagram/Configuration/#viewUnits'').

When you export a diagram, the component saves the diagram's data in its own text format. The resulting JSON object contains measurements in twips, regardless of the **units** or [viewUnits](/api-reference/10%20UI%20Components/dxDiagram/1%20Configuration/viewUnits.md '/api-reference/10%20UI%20Components/dxDiagram/1%20Configuration/viewUnits.md '/Documentation/ApiReference/UI_Components/dxDiagram/Configuration/#viewUnits'') property values. Do not modify this JSON object because modified data can load incorrectly.
