...
---
[note] The [labelLocation](/Documentation/ApiReference/UI_Components/dxForm/Configuration/#labelLocation) property value varies based on the theme (Generic or Material/Fluent). Adjust this setting if item labels are misaligned.
