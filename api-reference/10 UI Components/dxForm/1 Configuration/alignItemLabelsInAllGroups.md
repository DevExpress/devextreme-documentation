...
---
##### shortDescription
Specifies whether item labels in all groups are aligned. Applies only if the [labelMode](/Documentation/ApiReference/UI_Components/dxForm/Configuration/#labelMode) is *"default"*.
