...
---
##### shortDescription
Specifies whether item labels in all groups are aligned. Applies only if the [labelMode](/api-reference/10%20UI%20Components/dxForm/1%20Configuration/labelMode.md '/Documentation/ApiReference/UI_Components/dxForm/Configuration/#labelMode') is *"outside"*.
