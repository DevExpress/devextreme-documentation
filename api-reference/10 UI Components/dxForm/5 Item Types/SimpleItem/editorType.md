...
[note] This property does not [support](/Documentation/ApiReference/UI_Components/dxForm/Types/#FormItemComponent) all editors. You can use a [template](/Documentation/ApiReference/UI_Components/dxForm/Item_Types/SimpleItem/#template) to define a not supported component. 
