...
[note] This property does not support all editors. You can use a [template](/Documentation/ApiReference/UI_Components/dxForm/Item_Types/SimpleItem/#template) to define an unsupported component. 
