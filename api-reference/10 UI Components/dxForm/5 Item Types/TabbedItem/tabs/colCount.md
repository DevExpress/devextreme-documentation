...
For extra small screens, this option always equals *1* to make the UI component adaptive. Specify the [colCountByScreen](/api-reference/10%20UI%20Components/dxForm/5%20Item%20Types/TabbedItem/tabs/colCountByScreen '/Documentation/ApiReference/UI_Components/dxForm/Item_Types/TabbedItem/tabs/colCountByScreen/') option to override this logic.
