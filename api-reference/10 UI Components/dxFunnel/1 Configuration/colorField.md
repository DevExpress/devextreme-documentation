...
---
##### shortDescription
Specifies which data source field provides colors for funnel items. If this field is absent, the [palette](/api-reference/20%20Data%20Visualization%20Widgets/dxFunnel/1%20Configuration/palette.md '/Documentation/ApiReference/UI_Components/dxFunnel/Configuration/#palette') provides the colors.
