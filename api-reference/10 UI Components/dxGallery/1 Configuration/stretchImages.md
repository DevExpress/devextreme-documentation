...
---
If this property is set to **true**, the UI component enlarges images to fit the total gallery width. Otherwise, the UI component adds an appropriate margin between images to evenly distribute them along the gallery width.
