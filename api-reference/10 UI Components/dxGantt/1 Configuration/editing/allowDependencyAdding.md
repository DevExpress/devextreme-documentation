...
To add a dependency between two tasks, use the [insertDependency](/api-reference/10%20UI%20Components/dxGantt/3%20Methods/insertDependency(data).md '/Documentation/ApiReference/UI_Components/dxGantt/Methods/#insertDependencydata') method or move the mouse pointer over the preceding task's edge (marked with a circle) and drag the connector to the edge of the next task.
...
- [insertDependency](/api-reference/10%20UI%20Components/dxGantt/3%20Methods/insertDependency(data).md '/Documentation/ApiReference/UI_Components/dxGantt/Methods/#insertDependencydata')
