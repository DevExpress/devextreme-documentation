...
The UI component allows users to add, modify and delete tasks, resources and dependencies. Set the [enabled](/api-reference/10%20UI%20Components/dxGantt/1%20Configuration/editing/enabled.md '{basewidgetpath}/Configuration/editing/#enabled') option to **true** to enable edit functionality. 
