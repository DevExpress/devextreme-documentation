...
- **pdfDocument** - {[jsPDF](https://github.com/MrRio/jsPDF)} - Specifies the PDF document.
...
Use the following settings to create a PDF document and pass it to the Gantt component to export data to this document:
