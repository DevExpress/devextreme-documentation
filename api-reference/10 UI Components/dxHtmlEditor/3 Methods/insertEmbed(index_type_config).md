...
##### param(type): String
An embedded format's [name](/concepts/05%20UI%20Components/HtmlEditor/10%20Formats '/concepts/05%20UI%20Components/HtmlEditor/10%20Formats '/Documentation/Guide/UI_Components/HtmlEditor/Formats/'').

##### param(config): any
An embedded format's [value](/concepts/05%20UI%20Components/HtmlEditor/10%20Formats '/concepts/05%20UI%20Components/HtmlEditor/10%20Formats '/Documentation/Guide/UI_Components/HtmlEditor/Formats/'').
