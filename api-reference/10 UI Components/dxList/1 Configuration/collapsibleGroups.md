...
---
This option makes sense if the [grouped](/api-reference/10%20UI%20Components/dxList/1%20Configuration/grouped.md '/Documentation/ApiReference/UI_Components/dxList/Configuration/#grouped') option is set to **true**.
