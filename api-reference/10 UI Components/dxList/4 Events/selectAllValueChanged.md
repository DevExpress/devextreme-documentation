...
---
Main article: [onSelectAllValueChanged](/api-reference/10%20UI%20Components/dxList/1%20Configuration/onSelectAllValueChanged.md '/Documentation/ApiReference/UI_Components/dxList/Configuration/#onSelectAllValueChanged')
