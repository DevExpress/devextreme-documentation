...
---
You can use `component` field to access properties that are common for all supported Map [providers](/Documentation/ApiReference/UI_Components/dxMap/Types/#MapProvider). To access a provider-specific API, utilize the `originalMap` parameter. The examples below demonstrate this solution:
