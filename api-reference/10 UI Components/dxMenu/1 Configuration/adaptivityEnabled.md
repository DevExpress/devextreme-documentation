...
---
On small-screen devices, the Menu is shown as a list icon, and items have a tree structure like the [TreeView](/concepts/05%20UI%20Components/TreeView/00%20Overview.md '/Documentation/Guide/UI_Components/TreeView/Overview/') items if adaptive rendering is enabled.
