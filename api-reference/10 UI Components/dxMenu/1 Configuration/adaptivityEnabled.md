...
---
On small-screen devices, the Menu is shown as a list icon, and items have a tree structure like the [TreeView](/concepts/05%20UI%20Components/TreeView/00%20Getting%20Started%20with%20TreeView '/Documentation/Guide/UI_Components/TreeView/Getting_Started_with_TreeView/') items if adaptive rendering is enabled.
