...
---
To select an item on click and to visually display the selection, set the [selectByClick](/api-reference/10%20UI%20Widgets/dxMenuBase/1%20Configuration/selectByClick.md '/Documentation/ApiReference/UI_Components/dxMenu/Configuration/#selectByClick') option to **true**. Note that in this case the **selectionMode** should be *"single"*.
