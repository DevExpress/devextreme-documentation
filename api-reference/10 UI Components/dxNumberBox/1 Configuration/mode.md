...
---
[note] If you set the [format](/api-reference/10%20UI%20Widgets/dxNumberBox/1%20Configuration/format.md '/Documentation/ApiReference/UI_Components/dxNumberBox/Configuration/#format') property, the **mode** for mobile devices is changed to *"tel"*; *"number"* is not available.
