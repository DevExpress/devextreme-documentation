...
3. [Legend](/api-reference/10%20UI%20Components/dxPolarChart/9%20Types/Legend '{basewidgetpath}/Configuration/legend')
4. [Argument axis labels](/api-reference/10%20UI%20Components/dxPolarChart/9%20Types/CommonAxisSettings/label.md '{basewidgetpath}/Configuration/argumentAxis/label')
