...
---
Grid lines are the reference lines used to improve the readability of a chart's visual data. The **grid** object exposes the properties that allow you to specify visibility and appearance settings for axis grid lines. To learn more about axis grid lines and their properties, refer to the [Grid](/concepts/05%20Widgets/PolarChart/10%20Visual%20Elements/090%20Grid/01%20Grid.md '/Documentation/Guide/UI_Components/PolarChart/Visual_Elements/#Grid') topic.
