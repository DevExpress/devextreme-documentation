...
---
In addition to the [major grid](/api-reference/10%20UI%20Components/dxPolarChart/1%20Configuration/commonAxisSettings/grid '/Documentation/ApiReference/UI_Components/dxPolarChart/Configuration/commonAxisSettings/grid/') built on major ticks, the **PolarChart** UI component provides the minor grid that is built on minor ticks. The lines of the minor grid extend from the minor ticks throughout the entire chart's plot.
