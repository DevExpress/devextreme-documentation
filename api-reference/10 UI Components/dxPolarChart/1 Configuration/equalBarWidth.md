...
To set a custom angle for bars, as well as the spacing between bars, use the [barWidth](/api-reference/10%20UI%20Components/dxPolarChart/1%20Configuration/barWidth.md '/Documentation/ApiReference/UI_Components/dxPolarChart/Configuration/#barWidth') option.
