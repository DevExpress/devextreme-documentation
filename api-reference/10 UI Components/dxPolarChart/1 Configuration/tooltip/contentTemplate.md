...
<table class="dx-table full-width">
    ...
    <tr>
        ...
        <td>Information on the point being hovered over. For more information about the field and the point object's methods, refer to the <a href="/Documentation/ApiReference/UI_Components/dxPolarChart/Chart_Elements/Point/">Point</a> topic.</td>
    </tr>
    <tr>
