...
To specify the minimum visual range that a user can set, use the [minVisualRangeLength](/api-reference/10%20UI%20Components/dxPolarChart/1%20Configuration/valueAxis/minVisualRangeLength '/Documentation/ApiReference/UI_Components/dxPolarChart/Configuration/valueAxis/minVisualRangeLength/') option.
