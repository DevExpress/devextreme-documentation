...
---
<!--
dxPolarChartOptions.valueAxis.visualRangeUpdateMode(/api-reference/10 UI Components/dxPolarChart/9 Types/ValueAxis/visualRangeUpdateMode.md)(viz/polar_chart.d.ts)
-->