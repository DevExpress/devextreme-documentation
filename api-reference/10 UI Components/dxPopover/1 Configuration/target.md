...
This property also specifies a target element for the {WidgetName} [showEvent]({basewidgetpath}/Configuration/showEvent/) and [hideEvent]({basewidgetpath}/Configuration/hideEvent/).