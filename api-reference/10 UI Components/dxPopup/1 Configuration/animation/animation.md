...
---
Use the [position](/api-reference/10%20UI%20Components/dxPopup/1%20Configuration/position.md '/Documentation/ApiReference/UI_Components/dxPopup/Configuration/#position') option to specify the position in which the UI component is shown and from which it is hidden.
