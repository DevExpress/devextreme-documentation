...
You can set the [restorePosition]({basewidgetpath}/Configuration/#restorePosition) property to **false** if you want to display the {WidgetName} at the same position to which users dragged it.
