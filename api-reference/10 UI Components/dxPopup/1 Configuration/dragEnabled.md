...
You can set the [restorePostion]({basewidgetpath}/Configuration/#restorePosition) property to **true** to display the {WidgetName} at the same position to which users dragged it.
