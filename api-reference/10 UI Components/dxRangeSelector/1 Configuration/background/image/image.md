...
The width of the specified image must be less than or equal to the UI component's [width](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/size/width.md '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/size/#width').

The height of the specified image must be less than or equal to the following value ("-" stands for subtract): *the UI component's [height](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/size/height.md '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/size/#height')* - *the scale's [placeholderHeight](/api-reference/10%20UI%20Components/dxRangeSelector/1%20Configuration/scale/placeholderHeight.md '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/scale/#placeholderHeight')*.
