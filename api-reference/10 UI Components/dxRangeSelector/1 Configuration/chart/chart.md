...
The color specified for the range selector's background will also be visible in the chart's background by default. You can change it using the **color** property of the [background](/api-reference/20%20Data%20Visualization%20Widgets/dxRangeSelector/1%20Configuration/background/color.md '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/background/#color') configuration object. To prohibit the display of the background color, set the background's **visible** property to **false**.
