...
To set a custom width for bars, as well as the spacing between bars, use the [barWidth](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/barWidth.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/#barWidth') option.
