...
- **chart**.[paletteExtensionMode](/api-reference/10%20UI%20Components/dxRangeSelector/1%20Configuration/chart/paletteExtensionMode.md '{basewidgetpath}/Configuration/chart/#paletteExtensionMode')