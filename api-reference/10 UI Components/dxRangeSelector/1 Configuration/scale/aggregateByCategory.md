...
When **aggregateByCategory** is **true**, data is aggregated using the specified [aggregation method](/api-reference/10%20UI%20Components/dxChart/5%20Series%20Types/CommonSeries/aggregation '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/chart/series/aggregation/'#method).
