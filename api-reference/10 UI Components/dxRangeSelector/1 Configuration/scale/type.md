...
---
To decide on the scale type to use, check the [type of values](/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/scale/#valueType) the scale contains.
