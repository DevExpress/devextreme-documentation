...
---
<!--
dxRangeSelectorOptions.background.image.location(/api-reference/10 UI Components/dxRangeSelector/1 Configuration/background/image/location.md)(viz/range_selector.d.ts)
-->