...
- *"none"*      
The color specified in the [color](/api-reference/10%20UI%20Components/dxSankey/1%20Configuration/link/color.md '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/link/#color') option is used.
