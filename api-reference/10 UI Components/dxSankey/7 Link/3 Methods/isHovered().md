...
---
#####See Also#####
- **Link**.[hover(state)](/api-reference/20%20Data%20Visualization%20Widgets/dxSankey/7%20Link/3%20Methods/hover(state).md '/Documentation/ApiReference/UI_Components/dxSankey/Link/Methods/#hoverstate')
