...
---
Use this property to organize items of one resource kind into a hierarchy. For each child item, the specified field should contain the [valueExpr](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/resources/valueExpr.md '/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/resources/#valueExpr') value of its parent item. Leave the field empty for top-level items.
