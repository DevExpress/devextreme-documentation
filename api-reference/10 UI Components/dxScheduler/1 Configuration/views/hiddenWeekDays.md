...
This per-view setting overrides the component-level [hiddenWeekDays](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/hiddenWeekDays.md '/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/#hiddenWeekDays') value. If this property is not specified for a view, Scheduler uses the component-level value.
