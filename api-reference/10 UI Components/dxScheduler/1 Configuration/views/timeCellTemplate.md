...
---
Configure **timeCellTemplate** to customize the time scale. To customize the date scale, use [dateCellTemplate](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/views/dateCellTemplate.md '{currentpath}/#dateCellTemplate').
...
#####See Also#####
- [dateCellTemplate](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/views/dateCellTemplate.md '{currentpath}/#dateCellTemplate')
