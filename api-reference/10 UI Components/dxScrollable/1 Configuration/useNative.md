...
- When **useNative** is enabled and the component contains no focusable elements, [Axe](https://www.deque.com/axe/) reports a [false positive issue for scrollable-region-focusable](https://github.com/dequelabs/axe-core/issues/2822). This does not affect the accessibility level of your application. To resolve this issue, add the `tabindex="0"` attribute to the ScrollView content container.
