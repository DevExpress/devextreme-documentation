...
The example below shows how to define the **fieldTemplate**. If you want to customize this field's text, use the TextBox's [text](/Documentation/ApiReference/UI_Components/dxTextBox/Configuration/#text) property.
