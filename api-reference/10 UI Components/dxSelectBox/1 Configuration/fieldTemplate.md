...
The example below shows how to define the **fieldTemplate**. If you want to customize field text, use the TextBox [text](/Documentation/ApiReference/UI_Components/dxTextBox/Configuration/#text) property.
