...
---
If you want to change the component's [value]({basewidgetpath}/Configuration/#value) after a user releases the component's handle, set this property to `onHandleRelease`. The moment when the [onValueChanged]({basewidgetpath}/Configuration/#onValueChanged) function is called depends on this property:
