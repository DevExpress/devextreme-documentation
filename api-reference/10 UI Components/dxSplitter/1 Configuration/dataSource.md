...
#include common-dataSource-description with {
    widget_works_with: "{WidgetName} works with collections of [objects](/api-reference/10%20UI%20Components/dxSplitter/7%20Interfaces/dxSplitterItem '/Documentation/ApiReference/UI_Components/dxSplitter/Interfaces/dxSplitterItem/') or `string` values.",
