...
##### param(name): String
The button's [name](/api-reference/10%20UI%20Components/dxTextEditor/1%20Configuration/buttons '{basewidgetpath}/Configuration/buttons/'#name).

---
Use the returned button instance to call the [**Button** UI component's methods](/api-reference/10%20UI%20Components/dxButton '/Documentation/ApiReference/UI_Components/dxButton/'Methods/), for example, [focus()](/api-reference/10%20UI%20Components/dxButton '/Documentation/ApiReference/UI_Components/dxButton/'Methods/#focus):
