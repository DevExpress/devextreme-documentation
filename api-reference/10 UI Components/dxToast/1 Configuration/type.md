...
If you assign "custom" to the **type** property, the `dx-toast-custom` class is applied to the UI component element. Implement the appropriate CSS styles to specify toast appearance.
