...
Assign the same [group](/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/rowDragging/#group) value to the components to allow drag and drop between them. Implement [onAdd](/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/rowDragging/#onAdd) and [onRemove](/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/rowDragging/#onRemove) to update their data sources.
