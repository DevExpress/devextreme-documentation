...
---
##### shortDescription
Gets the keys of the rows selected explicitly [via the API](/concepts/05%20Widgets/TreeList/50%20Selection/20%20API/1%20Initial%20and%20Runtime%20Selection.md '/Documentation/Guide/UI_Components/TreeList/Selection/#API/Initial_and_Runtime_Selection') or via a click or tap.
