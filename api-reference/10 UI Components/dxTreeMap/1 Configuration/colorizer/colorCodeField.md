...
---
When you use the *"gradient"* or *"range"* colorization algorithm, the color of a tile depends on a value. Normally, this value is provided by the [value field](/api-reference/20%20Data%20Visualization%20Widgets/dxTreeMap/1%20Configuration/valueField.md '/Documentation/ApiReference/UI_Components/dxTreeMap/Configuration/#valueField'). However, you can assign another field to provide this value using the **colorCodeField** option.