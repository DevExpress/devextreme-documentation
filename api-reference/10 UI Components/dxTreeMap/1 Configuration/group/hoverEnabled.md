...
---
By default, this property inherits the value of the [hoverEnabled](/api-reference/20%20Data%20Visualization%20Widgets/dxTreeMap/1%20Configuration/hoverEnabled.md '/Documentation/ApiReference/UI_Components/dxTreeMap/Configuration/#hoverEnabled') property declared at the root level of the configuration object. Specify the **group**.**hoverEanbled** property only when you want to disable the hover state for groups, but not for tiles. In this case, set this property to **false**. 
