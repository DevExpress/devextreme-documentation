...
In addition, you can change the layout direction. For this purpose, use the [layoutDirection](/api-reference/10%20UI%20Components/dxTreeMap/1%20Configuration/layoutDirection.md '/Documentation/ApiReference/UI_Components/dxTreeMap/Configuration/#layoutDirection') option.
