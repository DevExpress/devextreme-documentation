...
---
##### shortDescription
Specifies the name of the data source field that provides parent IDs for items. Applies to plain [data sources](/api-reference/20%20Data%20Visualization%20Widgets/dxTreeMap/1%20Configuration/dataSource.md '/Documentation/ApiReference/UI_Components/dxTreeMap/Configuration/#dataSource') only.
