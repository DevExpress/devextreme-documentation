...
* **Color**     
There are several approaches to colorizing the tiles. Refer to the [color](/api-reference/10%20UI%20Components/dxTreeMap/1%20Configuration/tile/color.md '/Documentation/ApiReference/UI_Components/dxTreeMap/Configuration/tile/#color') option description to find information about all of them.
