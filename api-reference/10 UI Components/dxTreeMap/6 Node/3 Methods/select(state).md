...
---
[note]If the [selectionMode](/api-reference/10%20UI%20Components/dxTreeMap/1%20Configuration/selectionMode.md '/Documentation/ApiReference/UI_Components/dxTreeMap/Configuration/#selectionMode') option is set to *"single"*, calling this method with **true** as the argument selects one node and deselects all the others.
