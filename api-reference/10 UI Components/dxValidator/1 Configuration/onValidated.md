...
The value of the [name](/api-reference/10%20UI%20Components/dxValidator/1%20Configuration/name.md '/Documentation/ApiReference/UI_Components/dxValidator/Configuration/#name') option.
