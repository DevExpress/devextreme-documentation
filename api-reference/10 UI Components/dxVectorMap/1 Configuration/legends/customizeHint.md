...
[note]If you have not provided text for legend items using the [customizeText](/api-reference/10%20UI%20Components/dxVectorMap/1%20Configuration/legends/customizeText.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/legends/#customizeText') option, hints will not appear.