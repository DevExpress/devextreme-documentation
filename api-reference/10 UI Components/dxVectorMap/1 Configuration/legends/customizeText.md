...
The diameter of the legend item in pixels. This field is **undefined** if the [source](/api-reference/10%20UI%20Components/dxVectorMap/1%20Configuration/legends/source '/api-reference/10%20UI%20Components/dxVectorMap/1%20Configuration/legends/source '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/legends/#source'') is *'areaColorGroups'* or *'markerColorGroups'*.
