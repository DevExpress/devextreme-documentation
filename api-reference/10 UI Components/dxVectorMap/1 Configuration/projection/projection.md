...
To set a custom projection, implement two functions ([from](/api-reference/_hidden/VectorMapProjectionConfig/from.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/projection/#from') and [to](/api-reference/_hidden/VectorMapProjectionConfig/to.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/projection/#to')) that convert coordinates between geographical and UI component coordinate systems. The [to](/api-reference/_hidden/VectorMapProjectionConfig/to.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/projection/#to') callback is executed to render initial data in VectorMap. The [from](/api-reference/_hidden/VectorMapProjectionConfig/from.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/projection/#from') callback is called when a user executes the pan or move action. The [from](/api-reference/_hidden/VectorMapProjectionConfig/from.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/projection/#from') and [to](/api-reference/_hidden/VectorMapProjectionConfig/to.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/projection/#to') callbacks should have the same ratio:
