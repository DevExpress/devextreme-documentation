...
inherits: viz\vector_map:dxVectorMapTooltip
---
---
##### shortDescription
Configures tooltips.
...
- Enable tooltips.  
Set the [enabled](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/tooltip/enabled.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/tooltip/#enabled') property to **true**.

- Specify text to be displayed in tooltips.
Specify the [customizeTooltip](/api-reference/10%20UI%20Components/dxVectorMap/1%20Configuration/tooltip/customizeTooltip.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/tooltip/#customizeTooltip') property.
