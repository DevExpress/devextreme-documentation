...
[Empty items](/Documentation/ApiReference/UI_Widgets/dxForm/Item_Types/EmptyItem/) require that the [itemType](/Documentation/ApiReference/UI_Widgets/dxForm/Item_Types/EmptyItem/#itemType) property is set to *"empty"*.

- **Incorrect editorOptions configuration**         
[editorOptions](/Documentation/ApiReference/UI_Widgets/dxForm/Item_Types/SimpleItem/#editorOptions) configure the editor specified by the **editorType**. Ensure that **editorOptions** match the **editorType**. Review the editor's API reference and ensure that all used editor properties have correct values.
