...
[editorOptions](/Documentation/ApiReference/UI_Widgets/dxForm/Item_Types/SimpleItem/#editorOptions) configure the editor specified by the **editorType**. Check that **editorOptions** matches the **editorType**. Review the editor's API reference and ensure that all used editor options have correct values.