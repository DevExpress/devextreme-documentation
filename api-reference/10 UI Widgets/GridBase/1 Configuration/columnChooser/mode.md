...
<img src="/Content/images/doc/20_2/{WidgetName}/visual_elements/column-chooser_draganddrop-mode.png" alt="DevExtreme HTML5 JavaScript jQuery Angular Widget {WidgetName} ColumnChooser" style="margin-right:60px" /> <img src="/Content/images/doc/20_2/{WidgetName}/visual_elements/column-chooser_select-mode.png" alt="DevExtreme HTML5 JavaScript jQuery Angular Widget {WidgetName} ColumnChooser" style="margin-right:90px" />
