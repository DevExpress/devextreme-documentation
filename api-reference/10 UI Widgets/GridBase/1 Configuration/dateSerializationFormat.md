...
---
##### shortDescription
Specifies date-time values' serialization format. Use it only if you do not specify the [dataSource](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/dataSource.md '{basewidgetpath}/Configuration/#dataSource') at design time.
