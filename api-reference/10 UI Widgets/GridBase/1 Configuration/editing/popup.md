...
---
You can specify any [Popup property](/api-reference/10%20UI%20Widgets/dxPopup/1%20Configuration '/Documentation/ApiReference/UI_Widgets/dxPopup/Configuration/') in this object, but note that the following properties override the **{WidgetName}**'s internal logic:
