...
---
See the [Popup configuration](/api-reference/10%20UI%20Widgets/dxPopup '/Documentation/ApiReference/UI_Widgets/dxPopup/') for properties that you can specify in this object.
