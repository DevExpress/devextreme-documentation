...
---
To cancel row removal, assign **true** to the **cancel** field of the handler parameter. To perform an asynchronous action before removing the row, assign a [jQuery.Promise](https://api.jquery.com/Types/#Promise) to the **cancel** field. The row will be removed once the Deferred object of this Promise is resolved.
