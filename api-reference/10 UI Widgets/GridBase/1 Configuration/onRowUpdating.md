...
*Note:* Cancelling the update does not roll back changes. Call the [cancelEditData()](/api-reference/10%20UI%20Widgets/GridBase/3%20Methods/cancelEditData().md '{basewidgetpath}/Methods/#cancelEditData') method to revert to the previous values.
