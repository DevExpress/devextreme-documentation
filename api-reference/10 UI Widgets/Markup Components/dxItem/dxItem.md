...
---
The **dxItem** component defines custom markup for items in layout and collection widgets. **dxItem** has different options depending on the UI component where it is used. For a full list of them, see the **items** property description in a specific UI component's API Reference.
