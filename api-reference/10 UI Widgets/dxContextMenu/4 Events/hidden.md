...
---
Instead, you can use the [onHidden](/api-reference/10%20UI%20Widgets/dxContextMenu/1%20Configuration/onHidden.md '/Documentation/ApiReference/UI_Widgets/dxContextMenu/Configuration/#onHidden') option to handle the event.
