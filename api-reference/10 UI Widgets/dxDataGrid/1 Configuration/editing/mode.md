...
A user edits data cell by cell. The widget does not save changes until a user clicks the global *"Save"* button. See these two demos that edit data stored locally and remotely: [Batch Editing](https://js.devexpress.com/Demos/WidgetsGallery/Demo/{WidgetName}/BatchEditing) and [Batch Update Request](https://js.devexpress.com/Demos/WidgetsGallery/Demo/DataGrid/BatchUpdateRequest/jQuery/Light/).
