...
[note]This option cannot be enabled when [custom server-side summaries](/Documentation/Guide/Widgets/DataGrid/Summaries/Custom_Aggregate_Function/#Server-Side_Data_Aggregation) are used.
