...
---
##### shortDescription
A function used to customize a cell's [editor]({basewidgetpath}/Configuration/columns/#editorOptions). Not executed for cells with an [editCellTemplate]({basewidgetpath}/Configuration/columns/#editCellTemplate).
...
- Override the default editor's **onValueChanged** handler. For other default editor customizations, use [editorOptions]({basewidgetpath}/Configuration/columns/#editorOptions).
...
- Customize editors used in the [search panel]({basewidgetpath}/Configuration/searchPanel/), [filter row]({basewidgetpath}/Configuration/filterRow/), and [selection column](/concepts/05%20Widgets/DataGrid/15%20Columns/10%20Column%20Types/4%20Command%20Columns/00%20Command%20Columns.md '/Documentation/Guide/Widgets/{WidgetName}/Columns/Column_Types/Command_Columns/').        
