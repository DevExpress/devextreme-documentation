...
---
Instead, you can use the [onRowInserted](/api-reference/10%20UI%20Widgets/dxDataGrid/1%20Configuration/onRowInserted.md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/#onRowInserted') option to handle the event.
...
[note]In [batch edit mode](/concepts/05%20Widgets/DataGrid/070%20Data%20Editing/20%20Editing%20in%20UI/30%20Batch%20Mode.md '/Documentation/Guide/Widgets/DataGrid/Data_Editing/#Editing_in_UI/Batch_Mode'), when several rows have been inserted, the **rowInserted** event will fire for each row individually.
