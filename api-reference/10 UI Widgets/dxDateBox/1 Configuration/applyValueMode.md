...
- "useButtons"  
 Enables an end-user to apply the selected value or cancel the selection using the Apply and Cancel buttons respectively. Choosing this mode activates the [showTodayButton](/api-reference/10%20UI%20Widgets/dxCalendar/1%20Configuration/showTodayButton.md '/Documentation/ApiReference/UI_Widgets/dxCalendar/Configuration/#showTodayButton') option, and the *'today'* button appears in the left bottom corner.
