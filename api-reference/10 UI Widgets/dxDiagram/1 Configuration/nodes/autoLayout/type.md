...
---
 The **auto** value corresponds to **off** when the both shape coordinates (<xref:DevExpress.Web.ASPxDiagram.DiagramNodeMappingInfo.Left> and <xref:DevExpress.Web.ASPxDiagram.DiagramNodeMappingInfo.Top>) are specified; otherwise, the **auto** value corresponds to **layered**.
