...
---
 The **auto** value corresponds to **off** when both shape coordinates ([leftExpr](/Documentation/ApiReference/UI_Widgets/dxDiagram/Configuration/nodes/#leftExpr) and [topExpr](/Documentation/ApiReference/UI_Widgets/dxDiagram/Configuration/nodes/#topExpr)) are specified; otherwise, the **auto** value corresponds to **layered**.
