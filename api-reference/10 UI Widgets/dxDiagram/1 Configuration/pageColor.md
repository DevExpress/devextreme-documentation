...
- Page settings are stored in a diagram model. The **pageColor** property is not in effect if a diagram is read-only (the [readOnly](/Documentation/ApiReference/UI_Widgets/dxDiagram/Configuration/#readOnly)  property is set to **true**).
