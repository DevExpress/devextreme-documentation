...
<div class="simple-table">
    <table id="arrow-icon">
        ...
        <tr>
          ...
          <td><img src="/Content/images/doc/19_1/DevExtreme/show-arrow-icon-true.png" alt="DevExtreme DropDownButton with the showArrowIcon option set to true" /></td>
        </tr>
        <tr>
          <td><code>showArrowIcon: false</code></td>
          <td><img src="/Content/images/doc/19_1/DevExtreme/show-arrow-icon-false.png" alt="DevExtreme DropDownButton with the showArrowIcon option set to false" /></td>
        </tr>
    </table>
</div>
