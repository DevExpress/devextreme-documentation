...
<div class="simple-table normal-font-style">
    <table id="arrow-icon">
        ...
        <tr>
          ...
          <td><img src="/Content/images/doc/20_2/DevExtreme/show-arrow-icon-true.png" alt="DevExtreme DropDownButton with the showArrowIcon option set to true" /></td>
        </tr>
        <tr>
          <td><code>showArrowIcon: false</code></td>
          <td><img src="/Content/images/doc/20_2/DevExtreme/show-arrow-icon-false.png" alt="DevExtreme DropDownButton with the showArrowIcon option set to false" /></td>
        </tr>
    </table>
</div>
