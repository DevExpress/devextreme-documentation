...
---
Instead, you can use the [onUploadError](/api-reference/10%20UI%20Widgets/dxFileUploader/1%20Configuration/onUploadError.md '/Documentation/ApiReference/UI_Widgets/dxFileUploader/Configuration/#onUploadError') option to handle the event.
