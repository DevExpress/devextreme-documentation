...
---
Like the [items](/api-reference/10%20UI%20Widgets/dxForm/1%20Configuration/items.md '/Documentation/ApiReference/UI_Widgets/dxForm/Configuration/#items') option of the **Form** UI component, the array passed to the **items** field of a tab can hold items of the following types.
