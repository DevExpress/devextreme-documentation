...
Note that you cannot open the "Resource Manager" dialog if the **allowResourceDeleting** and [allowResourceAdding](/Documentation/ApiReference/UI_Widgets/dxGantt/editing/#allowResourceAdding) options are set to **false**.
...
#####See Also#####
- [onResourceDeleting](/Documentation/ApiReference/UI_Widgets/dxGantt/Configuration/#onResourceDeleting)
- [onResourceDeleted](/Documentation/ApiReference/UI_Widgets/dxGantt/Configuration/#onResourceDeleted)
- [deleteResource](/Documentation/ApiReference/UI_Widgets/dxGantt/Methods/#deleteResourcekey)
