...
---
Instead, you can use the [onPageLoading](/api-reference/10%20UI%20Widgets/dxLookup/1%20Configuration/onPageLoading.md '/Documentation/ApiReference/UI_Widgets/dxLookup/Configuration/#onPageLoading') option to handle the event.
