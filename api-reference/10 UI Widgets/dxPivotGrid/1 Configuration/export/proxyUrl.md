...
The sample proxy implementation for ASPx-based and PHP-based web servers is presented in the **DataGrid** | [Client-Side Export](/concepts/05%20Widgets/DataGrid/090%20Client-Side%20Export/040%20Set%20up%20Server-side%20Proxy '/Documentation/Guide/Widgets/DataGrid/Client-Side_Export/#Set_up_Server-side_Proxy') article.