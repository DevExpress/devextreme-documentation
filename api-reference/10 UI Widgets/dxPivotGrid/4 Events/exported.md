...
---
Instead, you can use the [onExported](/api-reference/10%20UI%20Widgets/dxPivotGrid/1%20Configuration/onExported.md '/Documentation/ApiReference/UI_Widgets/dxPivotGrid/Configuration/#onExported') option to handle the event.
