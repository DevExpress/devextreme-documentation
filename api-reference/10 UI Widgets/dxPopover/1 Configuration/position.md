...
[note]You can use the [position](/Documentation/ApiReference/UI_Widgets/dxPopover/Configuration/#position).[of](/api-reference/50%20Common/Object%20Structures/positionConfig/of.md '/Documentation/ApiReference/Common/Object_Structures/positionConfig/#of') option instead of the [target](/Documentation/ApiReference/UI_Widgets/dxPopover/Configuration/#target) option To specify the element against which the widget will be positioned. If both **target** and **position**.**of** are specified, the latter will take precedence. However, if the **of** field of the **position** object is not specified, the **target** option will be used.