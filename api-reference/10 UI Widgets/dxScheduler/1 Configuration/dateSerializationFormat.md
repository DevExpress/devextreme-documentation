...
---
##### shortDescription
Specifies the date-time values' serialization format. Use it only if you do not specify the [dataSource](/api-reference/10%20UI%20Widgets/dxScheduler/1%20Configuration/dataSource '{basewidgetpath}/Configuration/dataSource/') at design time.
