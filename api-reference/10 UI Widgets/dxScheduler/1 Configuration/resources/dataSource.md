...
The resource objects must have particular fields so that the **Scheduler** widget can present the resources for end users. For details, refer to the the [Define Resources](/concepts/05%20Widgets/Scheduler/40%20Resources/010%20Define%20Resources.md '/Documentation/Guide/Widgets/Scheduler/Resources/#Define_Resources') topic.