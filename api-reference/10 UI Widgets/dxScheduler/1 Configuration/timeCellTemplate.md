...
So, in the **Knockout approach**, you can bind template elements to the time scale item fields. To access another binding context within a template, use [Knockout](https://knockoutjs.com/documentation/binding-context.html) binding variables.
