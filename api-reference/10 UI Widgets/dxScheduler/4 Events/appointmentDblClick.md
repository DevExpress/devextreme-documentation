...
---
Instead, you can use the [onAppointmentDblClick](/api-reference/10%20UI%20Widgets/dxScheduler/1%20Configuration/onAppointmentDblClick.md '/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#onAppointmentDblClick') option to handle the event.
