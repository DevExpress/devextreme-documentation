...
---
Instead, you can use the [onMenuGroupRendered](/api-reference/10%20UI%20Widgets/dxSlideOut/1%20Configuration/onMenuGroupRendered.md '/Documentation/ApiReference/UI_Widgets/dxSlideOut/Configuration/#onMenuGroupRendered') option to handle the event.
