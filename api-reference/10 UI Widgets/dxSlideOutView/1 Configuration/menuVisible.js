...
var content = function (contentElement) {
    ...
    var field = $('<div style="text-align: center;">');
    var button = $("<div>").dxButton({
        text: 'Show Menu',
        onClick: function () {
            $("#mySlideOutView").dxSlideOutView("instance").option('menuVisible', true);
        }
    });
    field.append(button);
    contentElement.append(field);
};
var menu = function (menuElement) {
    ...
    var list = $("<div>").dxList({
        ...
        onItemClick: function (e) {
            ...
            $("#mySlideOutView").dxSlideOutView("instance").option('menuVisible', false);
