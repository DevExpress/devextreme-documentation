...
var menuPositionValue = 'normal',
    rtlEnabledValue = false;
var content = function (contentElement) {
    ...
    var fieldLabel1 = $('<div class="dx-field-value"></div>');
    var switchSelector = $("<div>").dxSwitch({
        value: rtlEnabledValue,
        onValueChanged: function (e) {
            rtlEnabledValue = e.value;
            $("#mySlideOutView").dxSlideOutView("instance").option("rtlEnabled", rtlEnabledValue);
        }
    });
    fieldLabel1.append(switchSelector);
    var field1 = $('<div class="dx-field">');
    field1.append('<div class="dx-field-label">rtlEnabled:</div>');
    field1.append(fieldLabel1);
    var fieldSet1 = $('<div class="dx-fieldset">');
    fieldSet1.append(field1);
    contentElement.append(fieldSet1);
    var fieldLabel2 = $('<div class="dx-field-value"></div>');
    var selectBox = $("<div>").dxSelectBox({
        items: ['normal', 'inverted'],
        value: menuPositionValue,
        onValueChanged: function (e) {
            menuPositionValue = e.value;
            $("#mySlideOutView").dxSlideOutView("instance").option("menuPosition", menuPositionValue);
        }
    });
    fieldLabel2.append(selectBox);
    var field2 = $('<div class="dx-field">');
    field2.append('<div class="dx-field-label">Menu position:</div>');
    field2.append(fieldLabel2);
    var fieldSet2 = $('<div class="dx-fieldset">');
    fieldSet2.append(field2);
    contentElement.append(fieldSet2);
