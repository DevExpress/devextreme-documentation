...
---
Instead, you can use the [onCut](/api-reference/10%20UI%20Widgets/dxTextEditor/1%20Configuration/onCut.md '{basewidgetpath}/Configuration/#onCut') option to handle the event.
