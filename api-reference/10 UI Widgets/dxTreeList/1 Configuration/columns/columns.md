...
- [columnOption(id, options)](/api-reference/10%20UI%20Widgets/dxTreeList/3%20Methods/columnOption(id_options).md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Methods/#columnOptionid_options')
