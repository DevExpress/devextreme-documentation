...
##### return: Promise<void>
A Promise that is resolved after the content is scrolled to the target item and rejected if the item doesn't exists or is located in the [disabled](/api-reference/10%20UI%20Widgets/dxTreeView/4%20Node/disabled.md '/Documentation/ApiReference/UI_Widgets/dxTreeView/Node/#disabled') node.             
