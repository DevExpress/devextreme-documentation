...
---
To specify only the subtitle's text, assign it directly to this option. Otherwise, set this property to an object with the **text** and other fields specified.