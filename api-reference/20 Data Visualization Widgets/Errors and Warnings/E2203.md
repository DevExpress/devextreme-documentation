...
---
##### shortDescription
Occurs in the [RangeSelector](/api-reference/20%20Data%20Visualization%20Widgets/dxRangeSelector '/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/') UI component when the selected range is invalid.
