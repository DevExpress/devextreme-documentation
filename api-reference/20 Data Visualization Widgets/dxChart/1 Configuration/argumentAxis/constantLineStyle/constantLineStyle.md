...
#####See Also#####
- **argumentAxis**.[constantLines[]](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/argumentAxis/constantLines/) - configures individual constant lines. Overrides the properties of the **argumentAxis**.**constantLineStyle** object, which is described here.
