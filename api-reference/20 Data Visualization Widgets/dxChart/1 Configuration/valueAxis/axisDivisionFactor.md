...
[note]If the **axisDivisionFactor** value leads [axis labels](/api-reference/20%20Data%20Visualization%20Widgets/dxChart/1%20Configuration/valueAxis/label '/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/valueAxis/label/') to overlapping, this value will be ignored.