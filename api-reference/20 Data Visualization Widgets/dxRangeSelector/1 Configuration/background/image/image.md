...
The width of the specified image must be less than or equal to the UI component's [width](/api-reference/20%20Data%20Visualization%20Widgets/BaseWidget/1%20Configuration/size/width.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/size/#width').
