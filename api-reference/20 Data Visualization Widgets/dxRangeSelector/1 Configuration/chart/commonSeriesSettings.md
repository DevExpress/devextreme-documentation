...
---
Use this object's properties to set the options for all chart series at once. These options include options common to all series types and options specific to certain series types. So if you have several series of one type, you can set options specific to this type. If you need to set an individual value for a common or type-specific property, use the corresponding **series** object within the **series** array. The values that are set individually override the corresponding common values.
