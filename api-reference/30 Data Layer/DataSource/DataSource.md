...
- DataSource is not designed to be used in multiple components simultaneously. If you want to share data between multiple widgets, create the [store object](/Documentation/Guide/Data_Binding/Data_Layer/#Creating_DataSource/What_Are_Stores) common for all components. Each component should wrap this store in a separate DataSource.
