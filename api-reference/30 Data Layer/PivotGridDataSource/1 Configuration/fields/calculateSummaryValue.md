...
---
This and [other post-processing functions](/api-reference/30%20Data%20Layer/PivotGridDataSource/1%20Configuration/fields/summaryDisplayMode.md '/Documentation/ApiReference/Data_Layer/PivotGridDataSource/Configuration/fields/#summaryDisplayMode') allow you to perform additional calculations on each summary value and take into account neighboring cells' summary values. You can hide specific rows if the **calculateSummaryValue** property returns **null**, and the [hideEmptySummaryCells](/Documentation/ApiReference/UI_Components/dxPivotGrid/Configuration/#hideEmptySummaryCells) property is **true**.
