...
---
##### shortDescription
Gets the current **PivotGridDataSource** state. Part of the **PivotGrid** widget's [state storing](/api-reference/10%20UI%20Widgets/dxPivotGrid/1%20Configuration/stateStoring '/Documentation/ApiReference/UI_Widgets/dxPivotGrid/Configuration/stateStoring/') feature.
