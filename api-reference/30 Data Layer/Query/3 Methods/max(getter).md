...
If a Query item is a numeric value, use the [max()](/api-reference/30%20Data%20Layer/Query/3%20Methods/max().md '/Documentation/ApiReference/Data_Layer/Query/Methods/#max') method instead of this one.
