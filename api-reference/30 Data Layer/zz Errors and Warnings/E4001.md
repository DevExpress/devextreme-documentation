...
---
This error may occur in UI components that include the "summary" feature. For example, if you specify a not-valid [summaryType](/api-reference/10%20UI%20Widgets/dxDataGrid/1%20Configuration/summary/groupItems/summaryType.md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/summary/groupItems/#summaryType') for the **DataGrid** UI component, this error will occur.