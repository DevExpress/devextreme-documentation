...
---
Configure this property to pass language information to the AI service in a system prompt. You can use language codes such as [ISO 639](https://en.wikipedia.org/wiki/ISO_639) and [IETF BCP 47](https://en.wikipedia.org/wiki/IETF_language_tag), or plain language names (for instance, "English").
