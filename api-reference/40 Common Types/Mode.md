...
dxPivotGridOptions.scrolling.useNative(/api-reference/10 UI Components/dxPivotGrid/1 Configuration/scrolling/useNative.md)
dxResponsiveBoxOptions.cols.baseSize(/api-reference/10 UI Components/dxResponsiveBox/1 Configuration/cols/baseSize.md)
dxResponsiveBoxOptions.rows.baseSize(/api-reference/10 UI Components/dxResponsiveBox/1 Configuration/rows/baseSize.md)
