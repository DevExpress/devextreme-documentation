...
dxChartOptions.argumentAxis.position(/api-reference/10 UI Components/dxChart/9 Types/dxChartArgumentAxis/position.md)(common.d.ts)
...
dxChartOptions.valueAxis.position(/api-reference/10 UI Components/dxChart/9 Types/dxChartValueAxis/position.md)(common.d.ts)
