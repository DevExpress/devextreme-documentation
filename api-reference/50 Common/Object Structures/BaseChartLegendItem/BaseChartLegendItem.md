...
---
#####See Also#####
- **Chart**.[legend](/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Configuration/legend/)
- **PolarChart**.[legend](/api-reference/10%20UI%20Components/dxPolarChart '/Documentation/ApiReference/UI_Components/dxPolarChart/'Configuration/legend/)