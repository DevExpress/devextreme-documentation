...
[note]With [modules](/Documentation/Guide/Common/Modularity/DevExtreme_Modules_Structure/), this flag is ignored, and the UI components use jQuery if the jQuery integration module is linked.