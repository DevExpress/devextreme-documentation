...
[note]With [modules](/concepts/Common/Modularity '/Documentation/Guide/Common/Modularity/'), this flag is ignored, and the widgets use jQuery if the jQuery integration module is linked.