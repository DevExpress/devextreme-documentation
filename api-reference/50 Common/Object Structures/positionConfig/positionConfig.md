...
---
This object should be assigned to the **position** option of an overlay widget ([Popup](/Documentation/ApiReference/UI_Widgets/dxPopup/), [Popover](/Documentation/ApiReference/UI_Widgets/dxPopover/), [Tooltip](/Documentation/ApiReference/UI_Widgets/dxTooltip/), etc.).

To position an element, specify the [my](/Documentation/ApiReference/Common/Object_Structures/positionConfig/my/), [at](/Documentation/ApiReference/Common/Object_Structures/positionConfig/at/), and [of](/Documentation/ApiReference/Common/Object_Structures/positionConfig/of/) options. In the following code, the left side of the **Popup** widget is aligned with the right side of a target. This configuration reads as follows: "place **my** *left* side **at** the *right* side of the *#target* element."
