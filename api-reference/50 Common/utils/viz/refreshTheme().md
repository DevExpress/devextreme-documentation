...
---
The **refreshTheme()** method calls [refresh()](/Documentation/ApiReference/UI_Components/dxChart/Methods/#refresh) to reload data and update the UI of all data visualization components after applying a new theme.
