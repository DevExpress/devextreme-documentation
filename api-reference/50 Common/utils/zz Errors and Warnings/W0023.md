...
For example, you can get the following packages in your warning:
    ...
    devextreme: 23.2.3
    DevExtreme.AspNet.Core: 23.2.4

In this case, upgrade the `devextreme` package or downgrade `DevExtreme.AspNet.Core` so both versions are either 23.2.3 or 23.2.4.