...
---
##### shortDescription
Configures the image to be displayed in the annotation. Applies only if the [type](/api-reference/_hidden/dxChartCommonAnnotationConfig/type.md '{basewidgetpath}/Configuration/annotations/#type') is *"image"*.
