...
Tooltips for annotations and series points have the same appearance as specified in the [tooltip](/api-reference/20%20Data%20Visualization%20Widgets/BaseChart/1%20Configuration/tooltip '{basewidgetpath}/Configuration/tooltip/') object. You can use the annotation's [customizeTooltip](/api-reference/_hidden/dxChartCommonAnnotationConfig/customizeTooltip.md '{basewidgetpath}/Configuration/annotations/#customizeTooltip') function to customize the annotation tooltip.