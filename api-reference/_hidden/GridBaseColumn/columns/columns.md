...
A nested column has almost every property a regular column has. These options are described in the [columns](/api-reference/_hidden/GridBaseColumn '/Documentation/ApiReference/UI_Components/dx{WidgetName}/Configuration/columns/') section of the Reference.
