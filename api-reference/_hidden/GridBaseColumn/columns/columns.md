...
A nested column has almost every property a regular column has. These properties are described in the [columns](/api-reference/_hidden/GridBaseColumn '/Documentation/ApiReference/UI_Widgets/dx{WidgetName}/Configuration/columns/') section of the Reference.
