...
---
This value is applied using the [selectedFilterOperation](/api-reference/_hidden/GridBaseColumn/selectedFilterOperation.md '{basewidgetpath}/Configuration/columns/#selectedFilterOperation'). If you need to filter dates, you should convert date strings into JavaScript [Date](https://www.w3schools.com/js/js_dates.asp) objects. Filter doesn't support dates specified as strings.
