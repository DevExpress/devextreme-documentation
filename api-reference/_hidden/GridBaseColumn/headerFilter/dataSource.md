...
To change the generated data source, set the **dataSource** option to a function. This function accepts an object whose `dataSource` field contains a [DataSource](/Documentation/ApiReference/Data_Layer/DataSource/) instance. Define the **DataSource**'s [postProcess](/Documentation/ApiReference/Data_Layer/DataSource/Configuration/#postProcess) function in which you can change header filter items.
