...
---
##### shortDescription
Specifies whether the column displays its values in editors in browse state.

---

Column cells can be in browse and edit states. In browse state, a cell value is text. In edit state, the cell contains an editor with the value and allows users to edit it. To display cell values in editors in edit and browse modes, set the **showEditorAlways** property to **true**.
