...
The option supports the following types of values:
 ...
 - **String**  
    ...
    [note] [Fixed columns](/concepts/05%20Widgets/DataGrid/15%20Columns/30%20Column%20Fixing.md '/Documentation/Guide/UI_Components/{WidgetName}/Columns/Column_Fixing/') ignore widths specified as a percentage.
