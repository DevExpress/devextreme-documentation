...
If the lookup data source contains objects, specify the [valueExpr](/api-reference/_hidden/dxFilterBuilderField/lookup/valueExpr.md '/Documentation/ApiReference/UI_Widgets/dxFilterBuilder/Configuration/fields/lookup/#valueExpr') and [displayExpr](/api-reference/_hidden/dxFilterBuilderField/lookup/displayExpr.md '/Documentation/ApiReference/UI_Widgets/dxFilterBuilder/Configuration/fields/lookup/#displayExpr') properties in addition to the **dataSource**.
