...
If you set **fileUploadMode** to `server` or `both`, you need to specify both [uploadUrl](/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/imageUpload/#uploadUrl) and [uploadDirectory](/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/imageUpload/#uploadDirectory).
