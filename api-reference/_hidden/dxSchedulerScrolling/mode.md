...
[note] Virtual mode is only available for *"day"*, *"week"*, and *"workWeek"* [views](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/views '/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/views/').
