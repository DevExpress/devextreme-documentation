#include angularjs-lts-note

All operations with widget options are carried out through the scope properties these options are bound to. To bind a widget option to a scope property, use the **bindingOptions** object as shown in the following code. The scope property name in this object is enclosed in quotes.
