...
To specify the value indicated by the bullet bar, assign it to the [value](/api-reference/20%20Data%20Visualization%20Widgets/dxBullet/1%20Configuration/value.md '/Documentation/ApiReference/UI_Components/dxBullet/Configuration/#value') property.
