...
If you need to define the **Button** content completely, implement a template for it using the [template](/api-reference/10%20UI%20Widgets/dxButton/1%20Configuration/template.md '/Documentation/ApiReference/UI_Components/dxButton/Configuration/#template') option as shown in the following example.
