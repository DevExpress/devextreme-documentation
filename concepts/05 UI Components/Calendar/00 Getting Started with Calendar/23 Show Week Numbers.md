To display a column with week numbers, assign `true` to the [showWeekNumbers](/Documentation/ApiReference/UI_Components/dxCalendar/Configuration/#showWeekNumbers) property. The default week number calculation rule depends on the locale. Use the [weekNumberRule](/Documentation/ApiReference/UI_Components/dxCalendar/Configuration/#weekNumberRule) setting to specify another week numeration rule.
