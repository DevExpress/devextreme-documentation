...
To specify which day should be considered the beginning of the week, pass its index (0 - for Sunday, 1 - for Monday, and so on) to the [firstDayOfWeek](/api-reference/10%20UI%20Components/dxCalendar/1%20Configuration/firstDayOfWeek.md '/api-reference/10%20UI%20Components/dxCalendar '/Documentation/ApiReference/UI_Components/dxCalendar/'Configuration/#firstDayOfWeek') property.
