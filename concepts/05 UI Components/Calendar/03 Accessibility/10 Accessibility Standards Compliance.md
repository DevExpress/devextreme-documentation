The Calendar component meets a variety of <a href="https://www.access-board.gov/ict/" target="_blank">Section 508</a> and <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" target="_blank">WCAG 2.x</a> compliance standards. Known exceptions are the following: 
...
<table class="dx-table">
    ...
    <tr>
        ...
        <td>Calendar does not pronounce selected range in multiselect mode. <br>
