...
The following code snippet restricts the CardView columns (fields) to `FullName`, `Position`, and `Email` and [allows column reordering](/Documentation/ApiReference/UI_Components/dxCardView/Configuration/#allowColumnReordering):
