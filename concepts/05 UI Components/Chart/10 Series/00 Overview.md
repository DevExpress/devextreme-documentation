...
The most important characteristic of a series is its type. The **Chart** provides over 20 series types, and all of them are described in the [Series Types](/Documentation/Guide/UI_Components/Chart/Series_Types/) article. You can specify the type of a series using its [type](/api-reference/10%20UI%20Components/dxChart/5%20Series%20Types/ChartSeries/type.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/series/#type') property.
