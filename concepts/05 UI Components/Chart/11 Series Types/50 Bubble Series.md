...
Assign *"bubble"* to the **series[]**.[type](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/series '/Documentation/ApiReference/UI_Components/dxChart/Configuration/series/'#type) property to specify the **Bubble** series type. You can configure:
