...
To configure point labels, use the fields of the [label](/api-reference/10%20UI%20Components/dxChart/5%20Series%20Types/CommonSeries/label '/Documentation/ApiReference/UI_Components/dxChart/Configuration/series/label/') object. This object can be declared as follows.
...
For details on other properties of point labels, refer to the [label](/api-reference/10%20UI%20Components/dxChart/5%20Series%20Types/CommonSeries/label '/Documentation/ApiReference/UI_Components/dxChart/Configuration/series/label/') section of the API reference and to other topics in this section.
