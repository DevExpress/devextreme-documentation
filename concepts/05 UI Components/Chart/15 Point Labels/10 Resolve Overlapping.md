In multi-series charts, point labels often overlap. To decide how to resolve overlapping, employ the [resolveLabelOverlapping](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/resolveLabelOverlapping.md '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Configuration/#resolveLabelOverlapping') property. It allows you to hide certain labels, or arrange all labels in stacks, or keep the labels as they are (i.e. overlapping).
