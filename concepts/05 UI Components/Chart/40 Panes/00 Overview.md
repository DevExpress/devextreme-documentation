...
Panes are configured by the [panes](/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Configuration/panes/) property. For a single-pane chart, this property accepts an object that configures the [background color](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/commonPaneSettings/backgroundColor.md '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Configuration/panes/#backgroundColor') and the [border](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/commonPaneSettings/border '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Configuration/panes/border/') of the pane.
