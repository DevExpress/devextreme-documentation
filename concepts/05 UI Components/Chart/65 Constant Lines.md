...
For information about all options of the constant lines, visit the [constantLines](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/argumentAxis/constantLines '/Documentation/ApiReference/UI_Components/dxChart/Configuration/argumentAxis/constantLines/') section of the API reference.
