...
To enable the crosshair, set the **crosshair**.[enabled](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/crosshair/enabled.md '/api-reference/10%20UI%20Components/dxChart/1%20Configuration/crosshair '/Documentation/ApiReference/UI_Components/dxChart/Configuration/crosshair/'#enabled') property to **true**. To show the crosshair labels, do the same with the **crosshair**.[label](/api-reference/10%20UI%20Components/dxChart/1%20Configuration/crosshair/label '/api-reference/10%20UI%20Components/dxChart/1%20Configuration/crosshair '/Documentation/ApiReference/UI_Components/dxChart/Configuration/crosshair/'label/').**visible** property.
