...
To activate the loading indicator, assign **true** to the [loadingIndicator](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/loadingIndicator '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Configuration/loadingIndicator/').**enabled** property. When activated, the indicator will be displayed or hidden automatically as the chart's data is updated.
...
If you need to show or hide the loading indicator at runtime, call the [showLoadingIndicator()](/api-reference/10%20UI%20Components/BaseWidget/3%20Methods/showLoadingIndicator().md '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Methods/#showLoadingIndicator') or [hideLoadingIndicator()](/api-reference/10%20UI%20Components/BaseWidget/3%20Methods/hideLoadingIndicator().md '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/'Methods/#hideLoadingIndicator') method.
