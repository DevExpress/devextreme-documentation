To navigate from the first to the second view, filter data by a different `parentID` in the **Chart**'s [onPointClick](/api-reference/10%20UI%20Components/BaseChart/1%20Configuration/onPointClick.md '/Documentation/ApiReference/UI_Components/dxChart/Configuration/#onPointClick') event handler. To navigate back, add the [Button](/api-reference/10%20UI%20Components/dxButton '/Documentation/ApiReference/UI_Components/dxButton/') UI component and reset the filter in the [onClick](/api-reference/10%20UI%20Components/dxButton '/Documentation/ApiReference/UI_Components/dxButton/'Configuration/#onClick) event handler. Distinguish between levels using the `isFirstLevel` flag.
