UI elements like [tooltips](/concepts/05%20UI%20Components/Chart/30%20Tooltips/00%20Overview.md '/Documentation/Guide/UI_Components/Chart/Tooltips/Overview/') and [axis labels](/Documentation/Guide/UI_Components/Chart/Axes/Axis_Labels/) display incorrect data when you convert the chart's values from positive to negative. You can fix this by customizing these elements' text:
