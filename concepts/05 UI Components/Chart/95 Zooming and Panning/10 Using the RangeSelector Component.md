...
When your data source is updated in real time, the behavior of both the Chart's [visual range](/concepts/05%20UI%20Components/Chart/20%20Axes/03%20Visual%20and%20Whole%20Ranges.md '/Documentation/Guide/UI_Components/Chart/Axes/Visual_and_Whole_Ranges/') and the RangeSelector's selected range depends on the [selectedRangeUpdateMode](/api-reference/10%20UI%20Components/dxRangeSelector/1%20Configuration/selectedRangeUpdateMode.md '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/#selectedRangeUpdateMode') property specified for the RangeSelector:
...
If you need to fix the zoom window and allow users to only move it along the scale, set the [scale](/api-reference/10%20UI%20Components/dxRangeSelector/1%20Configuration/scale '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/scale/') object's [minRange](/api-reference/10%20UI%20Components/dxRangeSelector/1%20Configuration/scale/minRange '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/scale/minRange/') and [maxRange](/api-reference/10%20UI%20Components/dxRangeSelector/1%20Configuration/scale/maxRange '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/scale/maxRange/') properties to a single value defining the zoom window's length. Make sure you specify the initial zoom factor using the [value](/api-reference/10%20UI%20Components/dxRangeSelector/1%20Configuration/value '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/#value') property.
...
#####See Also#####
- [RangeSelector - Scale](/concepts/05%20UI%20Components/RangeSelector/10%20Visual%20Elements/10%20Scale '/Documentation/Guide/UI_Components/RangeSelector/Visual_Elements/#Scale')
