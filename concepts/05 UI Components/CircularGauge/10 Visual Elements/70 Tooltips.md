...
* **Font Settings**    
To customize the appearance of the tooltip text, define the font properties within the [font](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/tooltip/font '/Documentation/ApiReference/UI_Components/dxCircularGauge/Configuration/tooltip/font/') configuration object.

#include btn-open-demo with {
    href: "https://js.devexpress.com/Demos/WidgetsGallery/Demo/Gauges/GaugeTooltip/"
}
