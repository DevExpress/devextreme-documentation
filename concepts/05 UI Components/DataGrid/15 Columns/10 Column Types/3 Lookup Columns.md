...
Each lookup column has an individual [data source](/api-reference/_hidden/GridBaseColumn/lookup/dataSource.md '/api-reference/_hidden/dxDataGridColumn/lookup '/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/columns/lookup/'#dataSource') - a collection of objects that map the column's actual values to display values...
