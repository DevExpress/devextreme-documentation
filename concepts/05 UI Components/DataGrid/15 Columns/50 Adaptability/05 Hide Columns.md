...
If your DataGrid is inside a resizable container, you must call the [updateDimensions()](/Documentation/ApiReference/UI_Components/dxDataGrid/Methods/#updateDimensions) method on each container resize to rerender the component:
