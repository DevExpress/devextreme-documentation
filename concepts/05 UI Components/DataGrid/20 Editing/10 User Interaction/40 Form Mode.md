...
You can use a column's [formItem](/api-reference/10%20UI%20Components/dxDataGrid/1%20Configuration/columns '/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/columns/'#formItem) object to customize an individual simple item. See an example in its description. 
