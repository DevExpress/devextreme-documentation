...
You can check if there are any unsaved changes by calling the [hasEditData()](/api-reference/10%20UI%20Components/GridBase/3%20Methods/hasEditData().md '/Documentation/ApiReference/UI_Components/dxDataGrid/Methods/#hasEditData') method. Use the [saveEditData()](/api-reference/10%20UI%20Components/GridBase/3%20Methods/saveEditData().md '/api-reference/10%20UI%20Components/GridBase/3%20Methods/saveEditData().md '/Documentation/ApiReference/UI_Components/dxDataGrid/Methods/#saveEditData'') or [cancelEditData()](/api-reference/10%20UI%20Components/GridBase/3%20Methods/cancelEditData().md '/Documentation/ApiReference/UI_Components/dxDataGrid/Methods/#cancelEditData') method to save or cancel them, respectively.
