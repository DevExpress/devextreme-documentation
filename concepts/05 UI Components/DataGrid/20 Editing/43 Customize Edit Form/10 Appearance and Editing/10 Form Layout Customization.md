...
DataGrid automatically generates editors with the corresponding event handlers for form items based on column settings and other DataGrid options like [onEditorPrepared](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/columns/#dataField). Do not use the [editCellTemplate](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/columns/#editCellTemplate) or [editorOptions](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/columns/#editorOptions) property for items that are bound to **dataField** in the **editing.form** configuration. You can add [unbound items](/Documentation/Guide/UI_Components/Form/Configure_Simple_Items/#Create_an_Unbound_Simple_Item) in the same way as in a regular [Form](/Documentation/ApiReference/UI_Components/dxForm/) component.
