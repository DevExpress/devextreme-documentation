...
The DataGrid also supports external pagers. You can hide the built-in pager and configure a standalone [Pagination](/concepts/05%20UI%20Components/Pagination/00%20Overview '/Documentation/Guide/UI_Components/Pagination/Overview/') component to control the DataGrid. For more information, refer to the following example:
