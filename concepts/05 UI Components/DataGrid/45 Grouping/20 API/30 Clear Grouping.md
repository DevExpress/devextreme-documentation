...
You can ungroup data by all columns at once using the [clearGrouping()](/api-reference/10%20UI%20Widgets/dxDataGrid/3%20Methods/clearGrouping().md '/Documentation/ApiReference/UI_Components/dxDataGrid/Methods/#clearGrouping') method.
