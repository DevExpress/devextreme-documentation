...
[note] Keep the [search](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/columns/headerFilter/#search).**enabled** property set to `false` to avoid incorrect search results when mapping data source fields.
