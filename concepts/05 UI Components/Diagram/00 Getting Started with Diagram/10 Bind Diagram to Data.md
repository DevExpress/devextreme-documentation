...
For details about different ways to bind Diagram data, refer to the following help topic: [Data Binding](/Documentation/Guide/UI_Components/Diagram/Data_Binding/).
