...
Handle the [requestLayoutUpdate](/Documentation/ApiReference/UI_Components/dxDiagram/Configuration/#onRequestLayoutUpdate) event to make the Diagram recalculate and update the diagram layout each time data is reloaded.
