...
We recommend that you do not set the [reshapeOnPush](/Documentation/ApiReference/Data_Layer/DataSource/Configuration/#reshapeOnPush) property to `true` in the Diagram data source as it interferes with many of the diagram functions: Selection, History, Document Focus, etc.