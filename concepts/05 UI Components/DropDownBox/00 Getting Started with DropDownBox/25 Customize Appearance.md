...
- A drop-down button    
Specify the [showDropDownButton](/Documentation/ApiReference/UI_Components/dxDropDownBox/Configuration/#showDropDownButton) property. You can use the [dropDownButtonTemplate](/Documentation/ApiReference/UI_Components/dxDropDownBox/Configuration/#dropDownButtonTemplate) to customize the button appearance.
