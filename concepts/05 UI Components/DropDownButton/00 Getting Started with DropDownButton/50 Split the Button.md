The button can execute a custom action instead of opening the drop-down menu. To enable this behavior, split the button into two sections. Set the [splitButton](/api-reference/10%20UI%20Widgets/dxDropDownButton/1%20Configuration/splitButton.md '/Documentation/ApiReference/UI_Components/dxDropDownButton/Configuration/#splitButton') property to **true** and assign a function to the [onButtonClick](/api-reference/10%20UI%20Widgets/dxDropDownButton/1%20Configuration/onButtonClick.md '/Documentation/ApiReference/UI_Components/dxDropDownButton/Configuration/#onButtonClick') property:
