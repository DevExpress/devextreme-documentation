Use the [permissions](/api-reference/10%20UI%20Components/dxFileManager/1%20Configuration/permissions '/Documentation/ApiReference/UI_Components/dxFileManager/Configuration/permissions/') property to specify whether to allow or deny a user to manage files and directories in the FileManager UI component: copy, create, download, move, remove, rename, or upload. 
