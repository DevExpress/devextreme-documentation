...
The following examples show how to configure the **FileUploader** for each upload mode. Therein, the [name](/api-reference/10%20UI%20Components/dxFileUploader/1%20Configuration/name.md '/Documentation/ApiReference/UI_Components/dxFileUploader/Configuration/#name') option is required to access uploaded files on the server.
