...
contain data fields from a UI component's data source. For example, the following code allows to use the [List's](/concepts/05%20UI%20Components/List/00%20Getting%20Started%20with%20List '/Documentation/Guide/UI_Components/List/Getting_Started_with_List') `Name` and `Price` fields in the FilterBuilder:
