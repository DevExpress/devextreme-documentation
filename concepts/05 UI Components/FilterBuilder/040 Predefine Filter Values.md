...
Each lookup field has an individual [data source](/api-reference/_hidden/dxFilterBuilderField/lookup/dataSource.md '/api-reference/_hidden/dxFilterBuilderField/lookup '/Documentation/ApiReference/UI_Components/dxFilterBuilder/Configuration/fields/lookup/'#dataSource'). It can be a simple array of filter values...
