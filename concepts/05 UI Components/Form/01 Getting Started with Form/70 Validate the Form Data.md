...
In the following example, we specify the [isRequired](Documentation/ApiReference/UI_Components/dxForm/Item_Types/SimpleItem/#isRequired) property for the `Name` item. We also specify the [NumericRule](/Documentation/ApiReference/UI_Widgets/dxValidator/Validation_Rules/NumericRule/) for `officeNumber` and [EmailRule](/Documentation/ApiReference/UI_Widgets/dxValidator/Validation_Rules/EmailRule/) for `Email` items.
