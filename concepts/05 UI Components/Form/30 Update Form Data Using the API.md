If you need to update form data at runtime, redefine the [formData](/api-reference/10%20UI%20Components/dxForm/1%20Configuration/formData.md '/api-reference/10%20UI%20Components/dxForm/1%20Configuration/formData.md '/api-reference/10%20UI%20Components/dxForm '/Documentation/ApiReference/UI_Components/dxForm/'Configuration/#formData'') object. In this case, form item values are updated automatically and the UI component is rerendered from scratch. In the following example, the [SelectBox](/api-reference/10%20UI%20Components/dxSelectBox '/Documentation/ApiReference/UI_Components/dxSelectBox/') UI component changes the **formData** object.
...
The **Form** UI component provides methods that update specific **formData** fields and rerender the corresponding editors without rerendering the whole UI component. The [updateData(dataField, value)](/api-reference/10%20UI%20Components/dxForm/3%20Methods/updateData(dataField_value).md '/api-reference/10%20UI%20Components/dxForm/3%20Methods/updateData(data).md '/api-reference/10%20UI%20Components/dxForm '/Documentation/ApiReference/UI_Components/dxForm/'Methods/#updateDatadata'Field_value') method updates the value of a single field. The [updateData(data)](/api-reference/10%20UI%20Components/dxForm/3%20Methods/updateData(data).md '/api-reference/10%20UI%20Components/dxForm '/Documentation/ApiReference/UI_Components/dxForm/'Methods/#updateDatadata') method updates values of several fields at once. In the following code, these methods are called on a [Button](/concepts/05%20UI%20Components/Button/00%20Overview.md '/Documentation/Guide/UI_Components/Button/Overview/') click.
...
With Angular, Vue or React, two-way binding to a component property is sufficient to update [formData](/api-reference/10%20UI%20Components/dxForm/1%20Configuration/formData.md '/api-reference/10%20UI%20Components/dxForm/1%20Configuration/formData.md '/api-reference/10%20UI%20Components/dxForm '/Documentation/ApiReference/UI_Components/dxForm/'Configuration/#formData'') at runtime. Swapping the whole **formData** object rerenders the UI component from scratch; updating specific **formData** fields rerenders only the corresponding editors.
