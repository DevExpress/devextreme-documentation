...
If you need to disable this feature, set the [hoverEnabled](/api-reference/10%20UI%20Components/dxFunnel/1%20Configuration/hoverEnabled.md '/Documentation/ApiReference/UI_Components/dxFunnel/Configuration/#hoverEnabled') property to **false**.
