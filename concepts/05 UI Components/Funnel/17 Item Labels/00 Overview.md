...
Options that configure item labels are collected in the [label](/api-reference/10%20UI%20Components/dxFunnel/1%20Configuration/label '/Documentation/ApiReference/UI_Components/dxFunnel/Configuration/label/') object. Refer to its description in the API reference or to other topics in this section for details on item label settings.
