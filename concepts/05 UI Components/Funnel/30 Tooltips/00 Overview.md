...
Properties declared in the **tooltip** object apply to all tooltips in the **Funnel**. If you want to customize a specific tooltip, assign a function to the [customizeTooltip](/api-reference/10%20UI%20Components/dxFunnel/1%20Configuration/tooltip '/Documentation/ApiReference/UI_Components/dxFunnel/Configuration/tooltip/'#customizeTooltip) property. This function must return an object with properties for the tooltip you want to customize.
