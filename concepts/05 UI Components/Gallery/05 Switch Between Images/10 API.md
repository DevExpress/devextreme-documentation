[note]In this article, the [Button](/concepts/05%20UI%20Components/Button/00%20Overview.md '/Documentation/Guide/UI_Components/Button/Overview/') UI component is used to switch images. This choice is made for purely demonstrational purposes, and you can do the same operations using another UI component following the same guidelines.

To switch the **Gallery** to the next or previous image, call the [nextItem(animation)](/api-reference/10%20UI%20Components/dxGallery/3%20Methods/nextItem(animation).md '/api-reference/10%20UI%20Components/dxGallery '/Documentation/ApiReference/UI_Components/dxGallery/'Methods/#nextItemanimation') or [prevItem(animation)](/api-reference/10%20UI%20Components/dxGallery/3%20Methods/prevItem(animation).md '/api-reference/10%20UI%20Components/dxGallery '/Documentation/ApiReference/UI_Components/dxGallery/'Methods/#prevItemanimation') method, respectively.
...
To navigate to a specific image, call the [goToItem(itemIndex, animation)](/api-reference/10%20UI%20Components/dxGallery/3%20Methods/goToItem(itemIndex_animation).md '/api-reference/10%20UI%20Components/dxGallery '/Documentation/ApiReference/UI_Components/dxGallery/'Methods/#goToItemitemIndex_animation') method. The first argument should be the index of the required image in the [dataSource](/api-reference/10%20UI%20Components/dxGallery/1%20Configuration/dataSource.md '/api-reference/10%20UI%20Components/dxGallery '/Documentation/ApiReference/UI_Components/dxGallery/'Configuration/#dataSource').
