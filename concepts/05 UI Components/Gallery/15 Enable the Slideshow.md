The **Gallery** UI component supports the display of images in a slideshow. To specify the time span that the UI component must wait before moving on to the next image, assign a positive number to the [slideshowDelay](/api-reference/10%20UI%20Components/dxGallery/1%20Configuration/slideshowDelay.md '/api-reference/10%20UI%20Components/dxGallery '/Documentation/ApiReference/UI_Components/dxGallery/'Configuration/#slideshowDelay') property. This number specifies the time span in milliseconds. If it is zero, slideshow is disabled.
