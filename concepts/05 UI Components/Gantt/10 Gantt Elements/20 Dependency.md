...
The **Gantt** UI component gets data for dependencies from a data source ([dataSource](/api-reference/10%20UI%20Components/dxGantt/1%20Configuration/dependencies/dataSource.md '/Documentation/ApiReference/UI_Components/dxGantt/Configuration/dependencies/#dataSource')). Dependency objects from the data source are automatically bound to the UI component if these objects have the default 'id', 'type', etc., data fields in their structure. For example:
