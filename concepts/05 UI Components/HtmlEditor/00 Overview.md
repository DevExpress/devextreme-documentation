...
2. Set the output markup language (HTML or Markdown) in the [valueType](/api-reference/10%20UI%20Components/dxHtmlEditor/1%20Configuration/valueType.md '/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/#valueType') property.
...
##### jQuery
    ...
    <head>
        ...
        <script type="text/javascript" src="https://cdn3.devexpress.com/jslib/minor_20_2/js/dx-quill.min.js"></script>
...
##### ASP.NET MVC Controls
    ...
    <script src="https://cdn3.devexpress.com/jslib/minor_20_2/js/dx-quill.min.js"></script>
    // Required if valueType is "markdown"
...
- [Adaptive toolbar](/concepts/05%20UI%20Components/HtmlEditor/20%20Toolbar/00%20Predefined%20Items '/Documentation/Guide/UI_Components/HtmlEditor/Toolbar/Predefined_Items/') 
- [Built-in formats' and modules' extension](/concepts/05%20UI%20Components/HtmlEditor/10%20Formats '/Documentation/Guide/UI_Components/HtmlEditor/Formats/'#Customize_Built-In_Formats_and_Modules)
