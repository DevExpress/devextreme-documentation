...
<table class="dx-table">
    <tr>
        <th>Toolbar Item</th>
        <th><a href="/api-reference/_hidden/dxHtmlEditorToolbar/items '/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/toolbar/items/'#formatName">formatName</a></th>
        <th><a href="/api-reference/_hidden/dxHtmlEditorToolbar/items '/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/toolbar/items/'#formatValues">formatValue</a></th>
    </tr>
    <tr>
        <td>"background"</td>
        <td>"background"</td>
...
To add a select box, specify the [formatName](/api-reference/_hidden/dxHtmlEditorToolbar/items '/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/toolbar/items/'#formatName) and [formatValues](/api-reference/_hidden/dxHtmlEditorToolbar/items '/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/toolbar/items/'#formatValues):
