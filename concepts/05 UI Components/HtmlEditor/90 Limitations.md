...
- Copy-pasting large or multiple images into HTML Editor can slow down input. To prevent this, use our [image upload](/Documentation/ApiReference/UI_Components/dxHtmlEditor/Configuration/imageUpload/) feature and block image pasting, as shown in this GitHub example:
