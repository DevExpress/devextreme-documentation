...
* **Location**    
You can place a title on any side of your gauge. For this purpose, use the [horizontalAlignment](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/title '/Documentation/ApiReference/UI_Components/dxLinearGauge/Configuration/title/'#horizontalAlignment) and [verticalAlignment](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/title '/Documentation/ApiReference/UI_Components/dxLinearGauge/Configuration/title/'#verticalAlignment) properties. Note that if these properties are specified, the subtitle will be displayed at the same position as the title.

* **Font Settings**    
To customize the appearance of the text, define the font properties within the [font](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/title '/Documentation/ApiReference/UI_Components/dxLinearGauge/Configuration/title/'font/) configuration object.