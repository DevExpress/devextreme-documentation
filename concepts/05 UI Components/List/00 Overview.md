...
The following code adds a simple **List** to your page. The simplest configuration of the UI component requires only a [dataSource](/api-reference/10%20UI%20Components/dxList/1%20Configuration/dataSource.md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Configuration/#dataSource') to be specified.
