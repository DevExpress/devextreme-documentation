...
If you need a more flexible solution, define a custom template for UI component items. For Angular, AngularJS, and Knockout apps, DevExtreme provides the [dxTemplate](/api-reference/10%20UI%20Components/Markup%20Components/dxTemplate '/Documentation/ApiReference/UI_Components/Markup_Components/dxTemplate/') markup component. The following code shows how to use **dxTemplate** to define a template for **List** items.
...
You can also customize an individual **List** item. For this purpose, declare a template for this item as a script and pass its `id` to the [template](/api-reference/10%20UI%20Components/dxList/1%20Configuration/items '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Configuration/items/'#template) field. 
