...
Implement the [onSelectionChanged](/api-reference/10%20UI%20Components/dxList/1%20Configuration/onSelectionChanged.md '/Documentation/ApiReference/UI_Components/dxList/Configuration/#onSelectionChanged') event handler to perform an action after a user selects items. To cancel selection programmatically, use [onSelectionChanging](/Documentation/ApiReference/UI_Components/dxList/Configuration/#onSelectionChanging). To see an example, refer to the following demo: [List Selection](https://js.devexpress.com/Demos/WidgetsGallery/Demo/List/ListSelection/).
