...
- **By key**    
Add or remove the key from the [selectedItemKeys](/api-reference/10%20UI%20Components/CollectionWidget/1%20Configuration/selectedItemKeys.md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Configuration/#selectedItemKeys') collection.
    ...
    [note]To specify the key field, use the [keyExpr](/api-reference/10%20UI%20Components/CollectionWidget/1%20Configuration/keyExpr.md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Configuration/#keyExpr') property of the **List** or the [key](/api-reference/30%20Data%20Layer/Store/1%20Configuration/key.md '/Documentation/ApiReference/Data_Layer/CustomStore/Configuration/#key') property of the **Store**.

- **By data object**      
Add or remove the data object from the [selectedItems](/api-reference/10%20UI%20Components/CollectionWidget/1%20Configuration/selectedItems.md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Configuration/#selectedItems') collection.
...
- **By index**        
Pass the index to the [selectItem(itemIndex)](/api-reference/10%20UI%20Components/dxList/3%20Methods/selectItem(itemIndex).md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Methods/#selectItemitemIndex') or [unselectItem(itemIndex)](/api-reference/10%20UI%20Components/dxList/3%20Methods/unselectItem(itemIndex).md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Methods/#unselectItemitemIndex') method. If the **List** is [grouped](/concepts/05%20UI%20Components/List/14%20Grouping/01%20In%20the%20Data%20Source.md '/Documentation/Guide/UI_Components/List/Grouping/In_the_Data_Source/'), these methods should be given an object with the indexes of the group and the item.
...
- **By DOM node**      
Pass the <a href="http://www.w3schools.com/js/js_htmldom_nodes.asp" target="_blank">DOM node</a> to the [selectItem(itemElement)](/api-reference/10%20UI%20Components/dxList/3%20Methods/selectItem(itemElement).md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Methods/#selectItemitemElement') or [unselectItem(itemElement)](/api-reference/10%20UI%20Components/dxList/3%20Methods/unselectItem(itemElement).md '/api-reference/10%20UI%20Components/dxList '/Documentation/ApiReference/UI_Components/dxList/'Methods/#unselectItemitemElement') method.
