...
To specify whether the **LoadIndicator** is shown, change the [visible](/api-reference/10%20UI%20Components/Widget/1%20Configuration/visible.md '/Documentation/ApiReference/UI_Components/dxLoadIndicator/Configuration/#visible') option.
