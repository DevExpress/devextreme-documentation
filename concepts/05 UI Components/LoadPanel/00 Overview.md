...
The following code adds to your page a simple **LoadPanel** and a [Button](/concepts/05%20UI%20Components/Button/00%20Overview.md '/Documentation/Guide/UI_Components/Button/Overview/') that invokes it. The [closeOnOutsideClick](/api-reference/10%20UI%20Components/dxOverlay/1%20Configuration/closeOnOutsideClick.md '/api-reference/10%20UI%20Components/dxLoadPanel '/Documentation/ApiReference/UI_Components/dxLoadPanel/'Configuration/#closeOnOutsideClick') property set to **true** instructs the **LoadPanel** to hide once a user clicks outside it.
