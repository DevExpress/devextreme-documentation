To change the text displayed by the **LoadPanel**, use the [message](/api-reference/10%20UI%20Components/dxLoadPanel/1%20Configuration/message.md '/api-reference/10%20UI%20Components/dxLoadPanel '/Documentation/ApiReference/UI_Components/dxLoadPanel/'Configuration/#message') property.
