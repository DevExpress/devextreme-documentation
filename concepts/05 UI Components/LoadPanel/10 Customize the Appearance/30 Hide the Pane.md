...
The pane is shown by default. To hide it, assign **false** to the [showPane](/api-reference/10%20UI%20Components/dxLoadPanel/1%20Configuration/showPane.md '/Documentation/ApiReference/UI_Components/dxLoadPanel/Configuration/#showPane') property.
