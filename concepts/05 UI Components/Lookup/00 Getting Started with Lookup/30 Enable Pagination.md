...
2. Use the DataSource's [pageSize](/Documentation/ApiReference/Data_Layer/DataSource/Configuration/#pageSize) property to specify the number of visible items on one page. If you group data (see the [Group Data](/Documentation/Guide/UI_Components/Lookup/Getting_Started_with_Lookup/#Group_Data) topic), the **pageSize** specifies the number of groups.
