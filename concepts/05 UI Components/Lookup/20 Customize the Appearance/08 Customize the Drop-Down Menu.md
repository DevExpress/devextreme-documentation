On desktops and iOS devices, the drop-down menu is the [Popover](/concepts/05%20UI%20Components/Popover/00%20Overview.md '/Documentation/Guide/UI_Components/Popover/Overview/') UI component; on other devices, it is the [Popup](/concepts/05%20UI%20Components/Popup/00%20Getting%20Started%20with%20Popup '/Documentation/Guide/UI_Components/Popup/Getting_Started_with_Popup/') UI component. To use the Popup on all devices, assign **false** to the [usePopover](/api-reference/10%20UI%20Components/dxLookup/1%20Configuration/usePopover.md '/Documentation/ApiReference/UI_Components/dxLookup/Configuration/#usePopover') property.
