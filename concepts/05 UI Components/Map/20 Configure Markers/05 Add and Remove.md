...
In the following code, a marker is added each time a user clicks someplace on the **Map**. The last marker from the **markers**  array is removed when the user clicks the [Button](/Documentation/Guide/UI_Components/Button/Getting_Started_with_Button/) under the **Map**.
