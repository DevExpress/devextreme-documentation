The **Map** UI component allows you to provide a single icon for all markers. For this purpose, assign the URL of the icon to the [markerIconSrc](/api-reference/10%20UI%20Components/dxMap/1%20Configuration/markerIconSrc.md '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Configuration/#markerIconSrc') property. In addition, you can customize the icon of an individual marker using the [iconScr](/api-reference/10%20UI%20Components/dxMap/1%20Configuration/markers/iconSrc.md '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Configuration/markers/#iconSrc') property.
...
Apart from the icon, you can specify a [tooltip](/api-reference/10%20UI%20Components/dxMap/1%20Configuration/markers/tooltip '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Configuration/markers/tooltip/') and [handle the click event](/api-reference/10%20UI%20Components/dxMap/1%20Configuration/markers/onClick.md '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Configuration/markers/#onClick') for an individual marker.
