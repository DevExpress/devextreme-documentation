To add routes at design-time, pass an array of objects to the [routes](/api-reference/10%20UI%20Components/dxMap/1%20Configuration/routes '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Configuration/routes/') property. A route requires only its [locations](/api-reference/10%20UI%20Components/dxMap/1%20Configuration/routes '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Configuration/routes/'locations/) to be specified. The locations will be connected and make up the route.
...
To add or remove a route at runtime, call the [addRoute(routeOptions)](/api-reference/10%20UI%20Components/dxMap/3%20Methods/addRoute(routeOptions).md '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Methods/#addRouterouteOptions') or [removeRoute(route)](/api-reference/10%20UI%20Components/dxMap/3%20Methods/removeRoute(route).md '/api-reference/10%20UI%20Components/dxMap '/Documentation/ApiReference/UI_Components/dxMap/'Methods/#removeRouteroute') method.
