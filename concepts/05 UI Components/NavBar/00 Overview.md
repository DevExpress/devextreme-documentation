...
The following code adds the **NavBar** to your page. All navigation items have icons and one of them has a [badge](/api-reference/_hidden/dxTabsItem/badge.md '/api-reference/10%20UI%20Components/dxTabs/1%20Configuration/items '/api-reference/10%20UI%20Components/dxNavBar '/Documentation/ApiReference/UI_Components/dxNavBar/'Configuration/items/'#badge'). 
...
Note that field names in these data source items are [conventional](/api-reference/10%20UI%20Components/dxTabs/1%20Configuration/items '/api-reference/10%20UI%20Components/dxNavBar '/Documentation/ApiReference/UI_Components/dxNavBar/'Configuration/items/'). This provides a default item appearance, which can be customized later.
