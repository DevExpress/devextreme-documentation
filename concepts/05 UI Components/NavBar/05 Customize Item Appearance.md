...
You can also customize an individual navigation item. For this purpose, declare a template for this item as a script and pass its `id` to the [template](/api-reference/10%20UI%20Components/dxTabs/1%20Configuration/items '/api-reference/10%20UI%20Components/dxNavBar '/Documentation/ApiReference/UI_Components/dxNavBar/'Configuration/items/'#template) field. 
