...
To specify the step by which the value is changed, use the [step](/api-reference/10%20UI%20Components/dxNumberBox/1%20Configuration/step.md '/Documentation/ApiReference/UI_Components/dxNumberBox/Configuration/#step') option.
