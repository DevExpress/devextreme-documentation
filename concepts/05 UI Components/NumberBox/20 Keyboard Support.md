...
<table class="dx-table">
    ...
    <tr>
        ...
        <td>Increases the UI component value by a <a href="/api-reference/10%20UI%20Components/dxNumberBox '/Documentation/ApiReference/UI_Components/dxNumberBox/'Configuration/#step">step</a>.</td>
    </tr>
    <tr>
        <td>&darr; or mouse wheel down</td>
        <td>Decreases the UI component value by a <a href="/api-reference/10%20UI%20Components/dxNumberBox '/Documentation/ApiReference/UI_Components/dxNumberBox/'Configuration/#step">step</a>.</td>
    </tr>
</table>
