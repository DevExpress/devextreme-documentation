...
For information about all options of the title and subtitle, visit the [title](/api-reference/20%20Data%20Visualization%20Widgets/dxPieChart/1%20Configuration/title.md '/Documentation/ApiReference/UI_Components/dxPieChart/Configuration/title/') section of the API reference.
