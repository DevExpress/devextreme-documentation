...
For information about all options of the title and subtitle, visit the [title](/api-reference/10%20UI%20Components/dxPieChart/1%20Configuration/title.md '/Documentation/ApiReference/UI_Components/dxPieChart/Configuration/title/') section of the API reference.
