...
When empty, each field area of the Field Panel displays an individual placeholder. If you need to change it, use the properties of the **fieldPanel**.[texts](/api-reference/10%20UI%20Components/dxPivotGrid/1%20Configuration/fieldPanel '/Documentation/ApiReference/UI_Components/dxPivotGrid/Configuration/fieldPanel/'texts/) object.
