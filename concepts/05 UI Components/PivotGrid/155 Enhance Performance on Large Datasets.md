...
For more information about the **createStore** method, refer to the following topic: [Web API, PHP and MongoDB Data Sources](/Documentation/Guide/Data_Binding/Specify_a_Data_Source/Web_API_and_MongoDB/)
