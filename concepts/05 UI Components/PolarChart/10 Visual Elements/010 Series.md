...
* **Individual Series Settings**		
	To set series properties to individual values, use the [series](/api-reference/20%20Data%20Visualization%20Widgets/dxPolarChart/1%20Configuration/series '/Documentation/ApiReference/UI_Components/dxPolarChart/Configuration/series/') array. The array items represent objects defining each series separately.
...
To identify series on the polar chart's [legend](/concepts/05%20Widgets/PolarChart/10%20Visual%20Elements/120%20Legend.md '/Documentation/Guide/UI_Components/PolarChart/Visual_Elements/#Legend'), set a name for each series, using its [name](/api-reference/_hidden/PolarChartSeries/name.md '/Documentation/ApiReference/UI_Components/dxPolarChart/Configuration/series/#name') property.
...
In addition to series properties, the **series** configuration object is used to set properties of the series [points](/concepts/05%20Widgets/PolarChart/10%20Visual%20Elements/020%20Series%20Points/10%20Series%20Points.md '/Documentation/Guide/UI_Components/PolarChart/Visual_Elements/#Series_Points') and [labels](/concepts/05%20Widgets/PolarChart/10%20Visual%20Elements/030%20Series%20Point%20Labels.md '/Documentation/Guide/UI_Components/PolarChart/Visual_Elements/#Series_Point_Labels').
