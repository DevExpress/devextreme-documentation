...
These and other options that can be set for *bar* series are explained in the [BarSeries](/api-reference/10%20UI%20Components/dxPolarChart/5%20Series%20Types/BarSeries '/Documentation/ApiReference/UI_Components/dxPolarChart/Series_Types/BarSeries/') Reference section. Set the required series options within the [series](/api-reference/10%20UI%20Components/dxPolarChart/1%20Configuration/series '/Documentation/ApiReference/UI_Components/dxPolarChart/Configuration/series/') object of the chart's configuration object.