...
To customize scale labels, use the options of the [label](/api-reference/20%20Data%20Visualization%20Widgets/dxRangeSelector/1%20Configuration/scale/label '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/scale/label/') configuration object.
...
- **Visibility**	
 By default, scale labels are visible. To hide them, set the [visible](/api-reference/20%20Data%20Visualization%20Widgets/dxRangeSelector/1%20Configuration/scale/label/visible.md '/Documentation/ApiReference/UI_Components/dxRangeSelector/Configuration/scale/label/#visible') option to **false**.
