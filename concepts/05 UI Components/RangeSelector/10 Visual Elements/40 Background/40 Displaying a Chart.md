...
Besides displaying a chart in the background, the RangeSelector UI component can be bound to the [Chart](/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart/') UI component in order to perform zooming and scrolling on the chart. Refer to the [End-User Interaction](/concepts/05%20UI%20Components/zz%20Common/10%20Data%20Visualization%20Widgets/90%20Charts%20-%20End-User%20Interaction/2%20Click%20Handling/1%20Series%20Click.md '/Documentation/Guide/UI_Components/Common/Data_Visualization_Widgets/Charts_-_End-User_Interaction/') topic to learn more about these advanced features.
