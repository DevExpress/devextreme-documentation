...
In addition, you can specify the step of **RangeSlider** values using the [step](/api-reference/10%20UI%20Components/dxSliderBase/1%20Configuration/step.md '/Documentation/ApiReference/UI_Components/dxRangeSlider/Configuration/#step') option.
