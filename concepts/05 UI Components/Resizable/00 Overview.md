...
To specify which sides of the **Resizable** - top, bottom, left, right or all at once - can be used for resizing content, set the [handles](/api-reference/10%20UI%20Components/dxResizable/1%20Configuration/handles.md '/Documentation/ApiReference/UI_Components/dxResizable/Configuration/#handles') option. Note that this option can accept several values separated with space.
