...
Nodes in a column are separated by a space. You can use the **node**.[padding](/api-reference/20%20Data%20Visualization%20Widgets/dxSankey/1%20Configuration/node/padding.md '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/node/#padding') property to specify this space. In the following code, this distance is reduced to 1 pixel:
...
Each column can be aligned vertically. You can find an example in the [alignment](/api-reference/20%20Data%20Visualization%20Widgets/dxSankey/1%20Configuration/alignment.md '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/#alignment') property's description.
