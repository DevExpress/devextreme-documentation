...
Properties that configure node labels are collected in the [label](/api-reference/10%20UI%20Components/dxSankey/1%20Configuration/label '/api-reference/10%20UI%20Components/dxSankey '/Documentation/ApiReference/UI_Components/dxSankey/'Configuration/label/') object. Refer to its description in the API reference and to other articles in this section for information on node label settings.
