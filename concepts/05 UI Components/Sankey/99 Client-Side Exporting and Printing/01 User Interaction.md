...
Set [export](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/export '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/export/').**enabled** to **true** to enable exporting and printing. To allow a user to only export, assign **false** to **export**.[printingEnabled](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/export '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/export/'#printingEnabled).
...
Change the **export**.[formats](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/export '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/export/'#formats) array to limit the set of export formats. You can also set the [fileName](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/export '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/export/'#fileName) property to specify the export file's name.
