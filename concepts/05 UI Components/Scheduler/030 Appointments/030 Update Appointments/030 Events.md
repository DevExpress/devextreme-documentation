To execute certain commands before or after an appointment was updated, handle the [appointmentUpdating](/api-reference/10%20UI%20Components/dxScheduler/4%20Events/appointmentUpdating.md '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Events/#appointmentUpdating') or [appointmentUpdated](/api-reference/10%20UI%20Components/dxScheduler/4%20Events/appointmentUpdated.md '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Events/#appointmentUpdated') event. If the event handling function is not going to be changed during the lifetime of the UI component, assign it to the corresponding **on*EventName*** property when you configure the UI component.
