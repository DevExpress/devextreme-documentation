...
You can also display appointment details outside of a tooltip. To learn how to do this, refer to the following example:

#include btn-open-github with {
    href: "https://github.com/DevExpress-Examples/devextreme-scheduler-create-custom-appointment-tooltip"
}
