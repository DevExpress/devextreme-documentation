Each resource kind has the [fieldExpr](/api-reference/10%20UI%20Widgets/dxScheduler/1%20Configuration/resources/fieldExpr.md '/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/resources/#fieldExpr') option. To associate an appointment with a resource, include a field specified in the **fieldExpr** option into the appointment's data object.
