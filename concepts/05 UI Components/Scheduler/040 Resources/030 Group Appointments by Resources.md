To group appointments by resources, assign an array to the [groups](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/groups.md '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Configuration/#groups') property. Each element of this array is **fieldExpr** of a resource kind. Note that the resource headers' order depends on the resources' order in the [resources](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/resources '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Configuration/resources/') array.
...
You can change resource headers' orientation in an individual view using the **views**.[groupOrientation](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/views/groupOrientation.md '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Configuration/views/#groupOrientation') property. In the following code, the orientation in the **day** view is *"vertical"*, so that resource headers are arranged in a column:
