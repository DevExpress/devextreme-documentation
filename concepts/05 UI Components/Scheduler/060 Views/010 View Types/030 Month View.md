...
In the month view, Scheduler renders appointments in ascending order of [startDateExpr](/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/#startDateExpr). If appointments have the same start date, they are rendered in the order defined in DataSource. You can use the DataSource's [sort](/Documentation/ApiReference/Data_Layer/DataSource/Configuration/#sort) property to reorder such appointments.
