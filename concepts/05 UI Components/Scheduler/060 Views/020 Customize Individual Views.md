To customize individual views, assign an array of configuration objects to the **views** property. Each object contains the [type](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/views/type.md '/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/views '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Configuration/views/'#type') property that defines which view is customized. Refer to the [API Reference](/api-reference/10%20UI%20Widgets/dxScheduler/1%20Configuration/views '/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/views '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Configuration/views/'') for a list of properties.
...
#####See Also#####
- [Scheduler - View Types](/concepts/05%20Widgets/Scheduler/060%20Views/010%20View%20Types '/concepts/05%20UI%20Components/Scheduler/060%20Views/010%20View%20Types '/Documentation/Guide/UI_Components/Scheduler/Views/View_Types/'')
