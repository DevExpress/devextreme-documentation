...
Use the [showCurrentTimeIndicator](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/showCurrentTimeIndicator.md '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Configuration/#showCurrentTimeIndicator') property to control the indicator's visibility.
...
Additionally, you can apply shading to cover the timetable up to the current time by assigning **true** to the [shadeUntilCurrentTime](/api-reference/10%20UI%20Components/dxScheduler/1%20Configuration/shadeUntilCurrentTime.md '/api-reference/10%20UI%20Components/dxScheduler '/Documentation/ApiReference/UI_Components/dxScheduler/'Configuration/#shadeUntilCurrentTime') property.
