If you need to group menu items, group them in the data source as shown in the following code. The **key** property gives names to groups; the [items](/api-reference/10%20UI%20Components/dxSlideOut/1%20Configuration/items '/api-reference/10%20UI%20Components/dxSlideOut '/Documentation/ApiReference/UI_Components/dxSlideOut/'Configuration/items/') property specifies menu items included in the group.
...
To let the UI component know that data it works with is grouped, assign **true** to the [menuGrouped](/api-reference/10%20UI%20Components/dxSlideOut/1%20Configuration/menuGrouped.md '/api-reference/10%20UI%20Components/dxSlideOut '/Documentation/ApiReference/UI_Components/dxSlideOut/'Configuration/#menuGrouped') property.
...
In some cases, you may need to define a custom template for group headers, for example, when the field providing group names differs from **key**, or if group headers need some customizations. To do this, use the [menuGroupTemplate](/api-reference/10%20UI%20Components/dxSlideOut/1%20Configuration/menuGroupTemplate.md '/api-reference/10%20UI%20Components/dxSlideOut '/Documentation/ApiReference/UI_Components/dxSlideOut/'Configuration/#menuGroupTemplate') callback function as shown in the following code.
