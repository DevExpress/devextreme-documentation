When it comes to customizing the view, you have two options to use: [itemTemplate](/api-reference/10%20UI%20Components/dxSlideOut/1%20Configuration/itemTemplate.md '/Documentation/ApiReference/UI_Components/dxSlideOut/Configuration/#itemTemplate') and [contentTemplate](/api-reference/10%20UI%20Components/dxSlideOut/1%20Configuration/contentTemplate.md '/Documentation/ApiReference/UI_Components/dxSlideOut/Configuration/#contentTemplate'). Which suits you best depends on whether the view itself reacts to changes in the menu in your use-case, or some other component inside the view does this.
