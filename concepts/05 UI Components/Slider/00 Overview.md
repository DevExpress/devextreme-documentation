...
In addition, you can specify the step of **Slider** values using the [step](/api-reference/10%20UI%20Components/dxSliderBase/1%20Configuration/step.md '/Documentation/ApiReference/UI_Components/dxSlider/Configuration/#step') option.
