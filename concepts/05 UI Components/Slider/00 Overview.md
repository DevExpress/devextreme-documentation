...
In addition, you can specify the step of **Slider** values using the [step](/api-reference/10%20UI%20Components/dxSliderBase/1%20Configuration/step.md '/api-reference/10%20UI%20Components/dxSlider '/Documentation/ApiReference/UI_Components/dxSlider/'Configuration/#step') property.
...
- [Slider - Customize UI component Appearance](/concepts/05%20UI%20Components/Slider/05%20Customize%20Widget%20Appearance.md '/Documentation/Guide/UI_Components/Slider/Customize_Widget_Appearance')
