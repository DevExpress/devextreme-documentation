...
* **Color**			
You can specify the color of the tooltip using the [color](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/tooltip/color.md '/Documentation/ApiReference/UI_Components/dxSparkline/Configuration/tooltip/#color') option.
