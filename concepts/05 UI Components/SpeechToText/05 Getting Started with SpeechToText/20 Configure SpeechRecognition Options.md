To configure **SpeechRecognition** options, specify the [speechRecognitionConfig]() object. This example enables continuous recognition (transcription continues after speech ends):
