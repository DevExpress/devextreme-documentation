The SpeechToText component meets a variety of <a href="https://www.access-board.gov/ict/" target="_blank">Section 508</a> and <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" target="_blank">WCAG 2.x</a> compliance standards. Known exceptions:  
...
<table class="dx-table">
    ...
    <tr>
        ...
        <td>SpeechToText does not support Windows High Contrast themes.</td>
    </tr>
</table>
