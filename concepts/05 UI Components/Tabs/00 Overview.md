...
The following code adds the **Tabs** UI component to your page. One of the tabs has an icon, another has a [badge](/api-reference/_hidden/dxTabsItem/badge.md '/api-reference/10%20UI%20Components/dxTabs/1%20Configuration/items '/api-reference/10%20UI%20Components/dxTabs '/Documentation/ApiReference/UI_Components/dxTabs/'Configuration/items/'#badge').
