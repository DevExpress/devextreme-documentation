...
When selected items overflow the input field, they are arranged in several lines. To disable this behavior, set the [multiline](/api-reference/10%20UI%20Components/dxTagBox/1%20Configuration/multiline.md '/Documentation/ApiReference/UI_Components/dxTagBox/Configuration/#multiline') option to **false**.
...
By default, selected items stay in the drop-down list. If they should be hidden after being selected, set the [hideSelectedItems](/api-reference/10%20UI%20Components/dxTagBox/1%20Configuration/hideSelectedItems.md '/Documentation/ApiReference/UI_Components/dxTagBox/Configuration/#hideSelectedItems') option to **true**.
...
The **TagBox** allows a user to clear selection in one click on the **Clear** button. To show this button, assign **true** to the [showClearButton](/api-reference/10%20UI%20Components/dxTextEditor/1%20Configuration/showClearButton.md '/Documentation/ApiReference/UI_Components/dxTagBox/Configuration/#showClearButton') option.
