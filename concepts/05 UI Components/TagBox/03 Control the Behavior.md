...
When selected items overflow the input field, they are arranged in several lines. To disable this behavior, set the [multiline](/api-reference/10%20UI%20Widgets/dxTagBox/1%20Configuration/multiline.md '/Documentation/ApiReference/UI_Components/dxTagBox/Configuration/#multiline') option to **false**.
