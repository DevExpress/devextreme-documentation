The TagBox can load data from different data source types. To use a local array, assign it to the [dataSource](/Documentation/ApiReference/UI_Components/dxTagBox/Configuration/#dataSource) property. If array elements are objects, set the fields that supply the TagBox's value ([valueExpr](/Documentation/ApiReference/UI_Components/dxTagBox/Configuration/#valueExpr)) and displayed value ([displayExpr](/Documentation/ApiReference/UI_Components/dxTagBox/Configuration/#displayExpr)). For information on other data source types, refer to the following articles:
