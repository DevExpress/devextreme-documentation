...
To handle the value change event, implement the [onValueChanged](/api-reference/10%20UI%20Components/dxTextArea/1%20Configuration/onValueChanged.md '/Documentation/ApiReference/UI_Components/dxTextArea/Configuration/#onValueChanged') function.
