...
[note] Another event that you can use is [input](/Documentation/ApiReference/UI_Components/dxTextArea/Events/#input). This is not a strictly keyboard event, a mouse action can also change TextArea input value.
