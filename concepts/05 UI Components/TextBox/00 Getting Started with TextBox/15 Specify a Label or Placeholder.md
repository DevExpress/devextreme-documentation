Use the [placeholder](/Documentation/ApiReference/UI_Components/dxTextBox/Configuration/#placeholder) property to give users a hint about what they should type in the TextBox. You can also use the [label](/Documentation/ApiReference/UI_Components/dxTextBox/Configuration/#label) property for this purpose. If you specify the **label** property, set the [labelMode](/Documentation/ApiReference/UI_Components/dxTextBox/Configuration/#labelMode) property to one of the following values:
