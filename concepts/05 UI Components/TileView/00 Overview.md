...
Note that field names in these data source items are [conventional](/api-reference/10%20UI%20Components/dxTileView/1%20Configuration/items '/api-reference/10%20UI%20Components/dxTileView '/Documentation/ApiReference/UI_Components/dxTileView/'Configuration/items/'). This provides a default tile appearance, which can be customized later. 

By default, the UI component is oriented horizontally, but you can orient it vertically using the [direction](/api-reference/10%20UI%20Components/dxTileView/1%20Configuration/direction.md '/api-reference/10%20UI%20Components/dxTileView '/Documentation/ApiReference/UI_Components/dxTileView/'Configuration/#direction') property. 
