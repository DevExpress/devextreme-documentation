The size of all tiles in the UI component is determined by the [baseItemHeight](/api-reference/10%20UI%20Widgets/dxTileView/1%20Configuration/baseItemHeight.md '/Documentation/ApiReference/UI_Components/dxTileView/Configuration/#baseItemHeight') and [baseItemWidth](/api-reference/10%20UI%20Widgets/dxTileView/1%20Configuration/baseItemWidth.md '/Documentation/ApiReference/UI_Components/dxTileView/Configuration/#baseItemWidth') options. If you need to set the size of a specific tile, use the [heightRatio](/api-reference/_hidden/dxTileViewItem/heightRatio.md '/Documentation/ApiReference/UI_Components/dxTileView/Configuration/items/#heightRatio') and [widthRatio](/api-reference/_hidden/dxTileViewItem/widthRatio.md '/Documentation/ApiReference/UI_Components/dxTileView/Configuration/items/#widthRatio') options of this tile. In this case, the size will be calculated according to the following formulas.
