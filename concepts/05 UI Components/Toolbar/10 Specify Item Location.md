To set the location of items on a toolbar, use the [location](/api-reference/_hidden/dxToolbarItem/location.md '/api-reference/10%20UI%20Components/dxToolbar '/Documentation/ApiReference/UI_Components/dxToolbar/'Configuration/items/#location') property. It accepts one of the following values.
...
When there is not enough width for all toolbar items, or if certain toolbar items are secondary, they can be rendered as commands on the overflow menu. This menu can be a [Popover](/Documentation/Guide/UI_Components/Popover/), an [Action Sheet](/Documentation/Guide/UI_Components/ActionSheet/) or a Drop-Down Menu, depending on which device the application is running on. To render a toolbar item as a command on the overflow menu, assign *"always"* or *"auto"* to the [locateInMenu](/api-reference/_hidden/dxToolbarItem/locateInMenu.md '/api-reference/10%20UI%20Components/dxToolbar '/Documentation/ApiReference/UI_Components/dxToolbar/'Configuration/items/#locateInMenu') property.
