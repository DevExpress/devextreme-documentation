...
You can also customize an individual toolbar item or menu command. For this purpose, declare a template for this item or command as a script and pass its `id` to the [template](/api-reference/10%20UI%20Components/dxToolbar/1%20Configuration/items '/api-reference/10%20UI%20Components/dxToolbar '/Documentation/ApiReference/UI_Components/dxToolbar/'Configuration/items/'#template) or [menuItemTemplate](/api-reference/10%20UI%20Components/dxToolbar/1%20Configuration/items '/api-reference/10%20UI%20Components/dxToolbar '/Documentation/ApiReference/UI_Components/dxToolbar/'Configuration/items/'#menuItemTemplate) property, respectively.
