The following code shows how to create a template consisting of static (text) and dynamic (the [Switch](/Documentation/Guide/UI_Components/Switch/Getting_Started_with_Switch/) UI component) content:
