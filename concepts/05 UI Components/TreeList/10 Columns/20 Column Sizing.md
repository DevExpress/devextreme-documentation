...
- **columns[]**.[width](/api-reference/_hidden/GridBaseColumn/width.md '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/columns/#width')/**columns[]**.[minWidth](/api-reference/_hidden/GridBaseColumn/minWidth.md '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/columns/#minWidth'): Specify width/minimum width for a specific column.
- [columnWidth](/api-reference/10%20UI%20Components/GridBase/1%20Configuration/columnWidth.md '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/#columnWidth')/[columnMinWidth](/api-reference/10%20UI%20Components/GridBase/1%20Configuration/columnMinWidth.md '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/#columnMinWidth'): Specify width/minimum width for all columns.
- [columnAutoWidth](/api-reference/10%20UI%20Components/GridBase/1%20Configuration/columnAutoWidth.md '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/#columnAutoWidth'): Adjusts all columns to fit cell values.
...
When the specified width of all columns exceeds the component's width, TreeList activates horizontal [scrolling](/api-reference/10%20UI%20Components/dxTreeList/1%20Configuration/scrolling '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/scrolling/').
