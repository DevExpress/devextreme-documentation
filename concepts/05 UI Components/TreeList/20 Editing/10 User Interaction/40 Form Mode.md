...
Configure the form using the **editing**.[form](/api-reference/10%20UI%20Components/GridBase/1%20Configuration/editing/form.md '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/editing/#form') object. The TreeList uses the DevExtreme [Form](/Documentation/ApiReference/UI_Components/dxForm/) UI component, so you can specify [any Form properties](/api-reference/10%20UI%20Components/dxForm/1%20Configuration '/Documentation/ApiReference/UI_Components/dxForm/Configuration/') in this object except those listed in its description.
