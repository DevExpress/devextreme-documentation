Use the [itemTemplate](/Documentation/ApiReference/UI_Components/dxTreeView/Configuration/#itemTemplate) property to specify a template for all nodes, as done in this tutorial. If you need to add a template for a specific node, use the [template](/Documentation/ApiReference/UI_Components/dxTreeView/Configuration/items/#template) node's property. This setting overrides the global template.  
