If you use plain data in the **TreeView**, set the [dataStructure](/api-reference/10%20UI%20Components/dxTreeView/1%20Configuration/dataStructure.md '/api-reference/10%20UI%20Components/dxTreeView '/Documentation/ApiReference/UI_Components/dxTreeView/'Configuration/#dataStructure') property to *"plain"*. For an example of plain data, see the following code snippet. 
...
As you can see, all items in a plain data source have the **id** and **text** fields, and items that have a parent, have the **parentId** field. Those are [conventional field names](/api-reference/10%20UI%20Components/dxTreeView/1%20Configuration/items '/api-reference/10%20UI%20Components/dxTreeView '/Documentation/ApiReference/UI_Components/dxTreeView/'Configuration/items/'). To use other names, change the [keyExpr](/api-reference/10%20UI%20Components/HierarchicalCollectionWidget/1%20Configuration/keyExpr.md '/api-reference/10%20UI%20Components/dxTreeView '/Documentation/ApiReference/UI_Components/dxTreeView/'Configuration/#keyExpr'), [displayExpr](/api-reference/10%20UI%20Components/dxTreeView/1%20Configuration/displayExpr.md '/api-reference/10%20UI%20Components/dxTreeView '/Documentation/ApiReference/UI_Components/dxTreeView/'Configuration/#displayExpr') and [parentIdExpr](/api-reference/10%20UI%20Components/dxTreeView/1%20Configuration/parentIdExpr.md '/api-reference/10%20UI%20Components/dxTreeView '/Documentation/ApiReference/UI_Components/dxTreeView/'Configuration/#parentIdExpr') properties, respectively.
