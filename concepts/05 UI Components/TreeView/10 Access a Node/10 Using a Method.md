Call the [getNodes()](/api-reference/10%20UI%20Components/dxTreeView/3%20Methods/getNodes().md '/api-reference/10%20UI%20Components/dxTreeView '/Documentation/ApiReference/UI_Components/dxTreeView/'Methods/#getNodes') method to get **TreeView** nodes at any point in the application flow.
...
All node objects contain a similar set of fields, which are described in the [Node](/api-reference/10%20UI%20Components/dxTreeView/4%20Node '/api-reference/10%20UI%20Components/dxTreeView '/Documentation/ApiReference/UI_Components/dxTreeView/'Node/') documentation section.
