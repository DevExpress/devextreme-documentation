...
* **Visibility**		
To hide the configured legend, set the [visible](/api-reference/10%20UI%20Components/BaseLegend/visible.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/legends/#visible') property to **false**.
