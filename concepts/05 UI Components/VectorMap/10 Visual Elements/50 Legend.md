...
* **Visibility**		
To hide the configured legend, set the [visible](/api-reference/20%20Data%20Visualization%20Widgets/BaseLegend/visible.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/legends/#visible') option to **false**.
