...
You can specify the JSON data object in [GeoJSON](https://en.wikipedia.org/wiki/GeoJSON) [FeatureCollection](https://datatracker.ietf.org/doc/html/rfc7946#section-3.3) format. VectorMap supports the following GeoJSON geometries:
