To provide data for map markers, assign an array of objects to the [dataSource](/api-reference/10%20UI%20Components/dxVectorMap/1%20Configuration/layers/dataSource.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/layers/#dataSource') property of a corresponding layer. For any marker type, each object of the **markers** array must contain the **coordinates** field, which must be assigned to an array of two values: the first is the longitude and the second is the latitude of a map marker. 
