Items can be arranged in a row or in a column depending on the value of the [direction](/api-reference/10%20UI%20Components/dxBox/1%20Configuration/direction.md '/Documentation/ApiReference/UI_Components/dxBox/Configuration/#direction') option.
