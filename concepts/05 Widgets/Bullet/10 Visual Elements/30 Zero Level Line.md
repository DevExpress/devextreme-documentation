...
By default, the zero level line is visible. However, in certain scenarios, you may need to change its visibility. For this purpose, use the [showZeroLevel](/api-reference/20%20Data%20Visualization%20Widgets/dxBullet/1%20Configuration/showZeroLevel.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxBullet/Configuration/#showZeroLevel') property.
