...
<div class="simulator-desktop-container" data-view="/Content/Applications/17_1/DataVisualization/Guides/ChartSeriesTypes/financial.html, /Content/Applications/17_1/DataVisualization/Guides/ChartSeriesTypes/financial.js"></div>

Assign *"candlestick"* or *"stock"* to the **series[]**.[type](/api-reference/20%20Data%20Visualization%20Widgets/dxChart/1%20Configuration/series/type.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/series/#type') option to specify the corresponding series type. You can configure:
