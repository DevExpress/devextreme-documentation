...
To activate the loading indicator, assign **true** to the [loadingIndicator](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/loadingIndicator '/Documentation/ApiReference/UI_Components/dxChart/Configuration/loadingIndicator/').**enabled** option. When activated, the indicator will be displayed or hidden automatically as the chart's data is updated.
