...
- **Drag Column**       
Contains drag icons. Appears when a column's [type](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#type) is *"drag"* and **rowDragging**.[allowReordering](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/rowDragging/#allowReordering) and [showDragIcons](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/rowDragging/#showDragIcons) are **true**.
