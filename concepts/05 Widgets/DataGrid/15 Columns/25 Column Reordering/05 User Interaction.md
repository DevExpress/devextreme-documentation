...
If a specific column should not be moved, set its [allowReordering](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/columns/allowReordering.md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#allowReordering') option to **false**.
