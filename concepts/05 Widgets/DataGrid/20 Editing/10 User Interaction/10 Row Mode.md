...
Clicking a *"Delete"* button invokes the confirmation dialog that allows a user to cancel row deletion. [confirmDelete](/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/editing/#confirmDelete] option to hide this dialog:
