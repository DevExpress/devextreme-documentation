...
The **DataGrid** widget allows you to process an updated cell value in the **columns**.[setCellValue](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/columns/setCellValue.md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#setCellValue') function before this value is saved to the data source. 
