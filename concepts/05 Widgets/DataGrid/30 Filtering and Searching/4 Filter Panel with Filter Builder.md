...
Set the **filterPanel**.[visible](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/filterPanel/visible.md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/filterPanel/#visible') property to **true** to make the filter panel visible. 
...
You can define the filter expression programmatically with the [filterValue](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/filterValue.md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/#filterValue') property. See the property's description for the full list of available filter operations and their peculiarities.
