Call the [pageCount()](/api-reference/10%20UI%20Widgets/dxDataGrid/3%20Methods/pageCount().md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Methods/#pageCount') method to get the total page count.
...
The **DataGrid** also provides the [pageIndex(newIndex)](/api-reference/10%20UI%20Widgets/dxDataGrid/3%20Methods/pageIndex(newIndex).md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Methods/#pageIndexnewIndex') and [pageSize(value)](/api-reference/10%20UI%20Widgets/dxDataGrid/3%20Methods/pageSize(value).md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Methods/#pageSizevalue') methods that switch the grid to a specific page and change the page size. They can also be called without arguments, in which case, they return the index and size of the current page.
