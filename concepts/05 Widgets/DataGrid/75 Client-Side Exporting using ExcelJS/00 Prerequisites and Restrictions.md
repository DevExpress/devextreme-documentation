...
- Excel's data format support is limited to the [predefined formats](/Documentation/ApiReference/Common/Object_Structures/format/#type) with the exception of *"largeNumber", "quarterAndYear", "second", "millisecond", "quarter", "hour"*, and *"minute"*. // TODO: Need think about it 
