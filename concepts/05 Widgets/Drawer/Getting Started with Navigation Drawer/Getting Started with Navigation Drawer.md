...
Refer to the subtopics for details on every configuration step. You can also find the full code in the following GitHub repository: <a href="https://github.com/DevExpress-Examples/getting-started-with-drawer" target="_blank">getting-started-with-drawer</a>
