Simple item [labels](/Documentation/ApiReference/UI_Widgets/dxForm/Item_Types/SimpleItem/label/) consist of the [formData](/Documentation/ApiReference/UI_Widgets/dxForm/Configuration/#formData) object field names. You can change the displayed text in the **label**.[text](/Documentation/ApiReference/UI_Widgets/dxForm/Item_Types/SimpleItem/label/#text) property. 
