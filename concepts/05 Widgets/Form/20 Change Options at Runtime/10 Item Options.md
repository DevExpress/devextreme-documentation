...
To change several options at a time, pass an object to the [itemOption(id, options)](/api-reference/10%20UI%20Components/dxForm/3%20Methods/itemOption(id_options).md '/Documentation/ApiReference/UI_Components/dxForm/Methods/#itemOptionid_options') method.
