...
Use the [showResources](/api-reference/10%20UI%20Widgets/dxGantt/1%20Configuration/showResources.md '/Documentation/ApiReference/UI_Components/dxGantt/Configuration/#showResources') option to specify whether the **Gantt** UI component hides resources or displays them as task labels.
...
- Resource Assignments: [dataSource](/api-reference/10%20UI%20Widgets/dxGantt/1%20Configuration/resourceAssignments/dataSource.md '/Documentation/ApiReference/UI_Components/dxGantt/Configuration/resourceAssignments/#dataSource') 
