...
- [Custom formats and modules](/api-reference/10%20UI%20Widgets/dxHtmlEditor/3%20Methods/getModule(modulePath).md '/Documentation/ApiReference/UI_Widgets/dxHtmlEditor/Methods/#getModulemodulePath')
