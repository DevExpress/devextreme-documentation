...
To configure scale labels, use the properties within the **scale**.[label](/api-reference/20%20Data%20Visualization%20Widgets/dxLinearGauge/1%20Configuration/scale/label '/Documentation/ApiReference/Data_Visualization_Widgets/dxLinearGauge/Configuration/scale/label/') object.
...
- **Visibility**	
You can show/hide scale labels using the [visible](/api-reference/20%20Data%20Visualization%20Widgets/BaseGauge/1%20Configuration/scale/label/visible.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxLinearGauge/Configuration/scale/label/#visible') property.
