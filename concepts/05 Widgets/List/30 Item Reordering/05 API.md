...
- **By DOM node**      
Pass the [DOM node](https://www.w3schools.com/js/js_htmldom_nodes.asp) to the [reorderItem(itemElement, toItemElement)](/api-reference/10%20UI%20Widgets/dxList/3%20Methods/reorderItem(itemElement_toItemElement).md '/Documentation/ApiReference/UI_Widgets/dxList/Methods/#reorderItemitemElement_toItemElement') method.
