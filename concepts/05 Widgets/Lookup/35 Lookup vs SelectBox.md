...
The **SelectBox** looks the same on any platform, while **Lookup** changes its appearance. The **Lookup**'s drop-down field is replaced with a popup window that occupies most of the screen. This design optimizes **Lookup** for mobile devices.
    ...
    <table class="dx-table">
        ...
        <tr>
            <td><img src="/Content/images/doc/19_2/UiWidgets/selectbox-mobile-desktop.png" alt="SelectBox on any device"></td>
            <td><img src="/Content/images/doc/19_2/UiWidgets/lookup-desktop.png" alt="Lookup on desktop"></td>
            <td><img src="/Content/images/doc/19_2/UiWidgets/lookup-mobile.png" alt="Lookup on mobile devices"></td>
        </tr>
    </table>
