...
Most primitive **Panorama** needs an collection of [items](/api-reference/10%20UI%20Widgets/dxPanorama/1%20Configuration/items.md '/Documentation/ApiReference/UI_Widgets/dxPanorama/Configuration/#items')
