...
To configure the appearance, location, and content of the legend, use options collected in the [legend](/api-reference/10%20UI%20Components/dxPieChart/1%20Configuration/legend '/Documentation/ApiReference/UI_Components/dxPieChart/Configuration/legend/') object. 
