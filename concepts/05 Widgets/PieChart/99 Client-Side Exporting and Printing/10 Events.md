...
You can handle these events with functions. If the handling functions are not going to be changed at runtime, assign them to the [onExporting](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/onExporting.md '/Documentation/ApiReference/UI_Components/dxPieChart/Configuration/#onExporting'), [onExported](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/onExported.md '/Documentation/ApiReference/UI_Components/dxPieChart/Configuration/#onExported') and [onFileSaving](/api-reference/10%20UI%20Components/BaseWidget/1%20Configuration/onFileSaving.md '/Documentation/ApiReference/UI_Components/dxPieChart/Configuration/#onFileSaving') options when you configure the UI component.
