...
If you do not need to display minor ticks at all, set the [showMinorTicks](/api-reference/20%20Data%20Visualization%20Widgets/dxRangeSelector/1%20Configuration/scale/showMinorTicks.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/scale/#showMinorTicks') option to *false*.
