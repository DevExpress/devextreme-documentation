...
The **RangeSlider** can also display a tooltip for the slider handles. To configure it, use the [tooltip](/api-reference/10%20UI%20Widgets/dxSlider/1%20Configuration/tooltip '/Documentation/ApiReference/UI_Widgets/dxRangeSlider/Configuration/tooltip/') object.
