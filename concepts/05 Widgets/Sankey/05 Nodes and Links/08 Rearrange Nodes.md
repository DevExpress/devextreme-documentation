...
Each column can be aligned vertically. You can find an example in the [alignment](/api-reference/10%20UI%20Components/dxSankey/1%20Configuration/alignment.md '/Documentation/ApiReference/UI_Components/dxSankey/Configuration/#alignment') option's description.
