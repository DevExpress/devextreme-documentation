...
To prevent an end user from adding an appointment, set the **editing**.[allowAdding](/api-reference/10%20UI%20Widgets/dxScheduler/1%20Configuration/editing/allowAdding.md '/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/editing/#allowAdding') option to **false**.
