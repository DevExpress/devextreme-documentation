Appointments are displayed in the client time zone. The time-zone offset specified in the [startDate](/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#dataSource#startDate) or [endDate](/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#dataSource#endDate) is also taken into account (if there is any). You can force a time zone for an individual appointment via its [startDateTimeZone](/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#dataSource#startDateTimeZone) and [endDateTimeZone](/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#dataSource#endDateTimeZone) fields or for all appointments in the widget via its [timeZone](/api-reference/10%20UI%20Widgets/dxScheduler/1%20Configuration/timeZone.md '/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#timeZone') option. **timeZone** takes precedence over **start**/**endDateTimeZone**.
