...
<div class="documentation-gallery">
    <script type="text/template"> 
        ...
        "images": [
            { "image": "Content/images/doc/16_2/UiWidgets/Scheduler_NormalAppointemnts.png", "text": "Normal Appointments" },
            { "image": "Content/images/doc/16_2/UiWidgets/Scheduler_NormalAppointmentDetails.png", "text": "Appointment Details" }
        ]}
    </script>
</div>