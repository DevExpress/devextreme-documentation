...
[note]To enable the pull-to-refresh gesture on desktops, set the [bounceEnabled](/api-reference/10%20UI%20Components/dxScrollable/1%20Configuration/bounceEnabled.md '/Documentation/ApiReference/UI_Components/dxScrollView/Configuration/#bounceEnabled') option to **true**.
