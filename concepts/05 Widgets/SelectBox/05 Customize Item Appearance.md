...
If you need a more flexible solution, define an [itemTemplate](/Documentation/ApiReference/UI_Widgets/dxSelectBox/Configuration/#itemTemplate) ([itemRender](/Documentation/ApiReference/UI_Widgets/dxSelectBox/Configuration/#itemRender) in React). Within the template, you can access item data and index:
