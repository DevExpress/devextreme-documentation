...
To let the UI component know that data it works with is grouped, assign **true** to the [menuGrouped](/api-reference/10%20UI%20Widgets/dxSlideOut/1%20Configuration/menuGrouped.md '/Documentation/ApiReference/UI_Widgets/dxSlideOut/Configuration/#menuGrouped') property.
