...
<table class="dx-table">
    ...
    <tr>
        ...
        <td>Scrolls the content left/right if the <a href="/Documentation/ApiReference/UI_Widgets/dxTileView/Configuration/#direction">direction</a> property is <i>"horizontal"</i>.</td>
    </tr>
    <tr>
