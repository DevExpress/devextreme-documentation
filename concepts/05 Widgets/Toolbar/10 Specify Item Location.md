To set the location of items on a toolbar, use the [location](/api-reference/_hidden/dxToolbarItem/location.md '/Documentation/ApiReference/UI_Widgets/dxToolbar/Configuration/items/#location') property. It accepts one of the following values.
