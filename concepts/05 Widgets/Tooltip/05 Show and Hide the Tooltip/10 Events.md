To execute certain commands before or after the **Tooltip** was shown/hidden, handle the [showing](/api-reference/10%20UI%20Components/dxOverlay/4%20Events/showing.md '/Documentation/ApiReference/UI_Components/dxTooltip/Events/#showing'), [shown](/api-reference/10%20UI%20Components/dxOverlay/4%20Events/shown.md '/Documentation/ApiReference/UI_Components/dxTooltip/Events/#shown'), [hiding](/api-reference/10%20UI%20Components/dxOverlay/4%20Events/hiding.md '/Documentation/ApiReference/UI_Components/dxTooltip/Events/#hiding') or [hidden](/api-reference/10%20UI%20Components/dxOverlay/4%20Events/hidden.md '/Documentation/ApiReference/UI_Components/dxTooltip/Events/#hidden') event. If the event handling function is not going to be changed during the lifetime of the UI component, assign it to the corresponding **on*EventName*** option when you configure the UI component.
...
If you are going to change event handlers at runtime, or if you need to attach several handlers to a single event, subscribe to the events using the [on(eventName, eventHandler)](/api-reference/10%20UI%20Components/Component/3%20Methods/on(eventName_eventHandler).md '/Documentation/ApiReference/UI_Components/dxTooltip/Methods/#oneventName_eventHandler') method. This approach is more typical of jQuery.
