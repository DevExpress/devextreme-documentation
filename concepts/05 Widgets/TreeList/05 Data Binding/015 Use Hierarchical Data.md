...
All items with children have the **items** field. If you use another name for this field, specify it in the [itemsExpr](/api-reference/10%20UI%20Widgets/dxTreeList/1%20Configuration/itemsExpr.md '/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/#itemsExpr') option.
