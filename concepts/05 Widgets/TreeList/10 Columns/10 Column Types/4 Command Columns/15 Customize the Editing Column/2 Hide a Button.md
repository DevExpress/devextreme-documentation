...
The **Add**, **Edit**, and **Delete** buttons can be hidden by omitting them when declaring the [buttons](/api-reference/10%20UI%20Widgets/dxTreeList/1%20Configuration/columns/buttons '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/buttons/') array. However, users can still use the keyboard to add, edit, and delete.
