...
If a specific column should not be moved, set its [allowReordering](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/columns/allowReordering.md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/#allowReordering') option to **false**.
...
#include common-demobutton with {
    url: "https://js.devexpress.com/Demos/WidgetsGallery/Demo/Tree_List/Reordering/jQuery/Light/"
}
