...
Clicking a *"Delete"* button invokes the confirmation dialog that allows a user to cancel row deletion. Use the [confirmDelete](/Documentation/20_1/ApiReference/UI_Widgets/dxTreeList/Configuration/editing/#confirmDelete) option to hide this dialog:
