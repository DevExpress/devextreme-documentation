...
The **TreeList** widget allows you to process an updated cell value in the **columns**.[setCellValue](/api-reference/10%20UI%20Widgets/dxTreeList/1%20Configuration/columns/setCellValue.md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/#setCellValue') function before this value is saved to the data source. 
