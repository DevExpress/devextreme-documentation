...
<div class="footnotes">
    <ol>
        ...
        <li>The <a href="/Documentation/Guide/UI_Components/TreeList/Filtering_and_Searching/#Search_Panel">search panel</a> must be visible.</li>
...
You can override these shortcuts or create your own shortcuts using the [onKeyDown](/Documentation/ApiReference/UI_Components/dxTreeList/Configuration/#onKeyDown) event handler.
