...
* **Visibility**		
To hide the configured legend, set the [visible](/api-reference/20%20Data%20Visualization%20Widgets/BaseLegend/visible.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxVectorMap/Configuration/legends/#visible') property to **false**.
