...
For setting initial zoom, assign a number greater than 1 to the [zoomFactor](/api-reference/10%20UI%20Components/dxVectorMap/1%20Configuration/zoomFactor.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/#zoomFactor') option.
