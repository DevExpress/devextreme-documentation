The appearance of map elements in the selected state can be customized using the [selectedColor](/api-reference/20%20Data%20Visualization%20Widgets/dxVectorMap/1%20Configuration/layers/selectedColor.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/layers/#selectedColor') and [selectedBorderColor](/api-reference/20%20Data%20Visualization%20Widgets/dxVectorMap/1%20Configuration/layers/selectedBorderColor.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/layers/#selectedBorderColor') options. Both of them specify the color, only the former specifies it of map elements, while the latter specifies it of their borders.
