Map elements may appear selected when the map is loaded. To accomplish this, implement the [customize](/api-reference/10%20UI%20Components/dxVectorMap/1%20Configuration/layers/customize.md '/Documentation/ApiReference/UI_Components/dxVectorMap/Configuration/layers/#customize') function that must return an object with the **isSelected** field set to **true** for those areas or markers that must appear selected. The following code snippet provides an example of implementing this function.
