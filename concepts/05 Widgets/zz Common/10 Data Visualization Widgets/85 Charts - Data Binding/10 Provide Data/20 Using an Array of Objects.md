...
In **Chart**, the majority of [series types](/concepts/05%20Widgets/Chart/20%20Series%20Types '/Documentation/Guide/Widgets/Chart/Series_Types/') requires one value for one argument to define one series point. Data sources for such series are represented above. However, there are series types that require two or more values for one argument to define one point. For example, a [range area](/concepts/05%20Widgets/Chart/20%20Series%20Types/Range%20Area.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Range_Area') or [range bar](/concepts/05%20Widgets/Chart/20%20Series%20Types/Range%20Bar.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Range_Bar') series needs two values, while a [candle stick](/concepts/05%20Widgets/Chart/20%20Series%20Types/Candle%20Stick.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Candle_Stick') or [stock](/concepts/05%20Widgets/Chart/20%20Series%20Types/Stock.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Stock') series needs four values for one argument. The code snippet below shows how to implement a data source for two series of the range bar type.
