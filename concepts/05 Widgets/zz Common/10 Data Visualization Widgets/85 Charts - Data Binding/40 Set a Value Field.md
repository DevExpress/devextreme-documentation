...
If you have only one series in your chart, specify the **valueField** option within the [series](/api-reference/20%20Data%20Visualization%20Widgets/dxChart/1%20Configuration/series '/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/series/') object.
	...
	Certain series types require several value fields to be specified for one series. In these instances, data source fields must be set using options particular to a specific series type. For example, the following code snippet shows how to specify value fields for a [Range Area](/concepts/05%20Widgets/Chart/20%20Series%20Types/Range%20Area.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Range_Area') and [Range Bar](/concepts/05%20Widgets/Chart/20%20Series%20Types/Range%20Bar.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Range_Bar') series.
	...
	The following code demonstrates how to set value fields for the [Candle Stick](/concepts/05%20Widgets/Chart/20%20Series%20Types/Candle%20Stick.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Candle_Stick') and [Stock](/concepts/05%20Widgets/Chart/20%20Series%20Types/Stock.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Stock') series types.
	...
	Series of the [Bubble](/concepts/05%20Widgets/Chart/20%20Series%20Types/Bubble.md '/Documentation/Guide/Widgets/Chart/Series_Types/#Bubble') type slightly differ from other series. Along with the value field, they require the size field to be specified. The code below illustrates how to specify the value and size fields for the *bubble* series.
