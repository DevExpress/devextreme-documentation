...
To validate a DevExtreme editor, the latter should be associated with the [dxValidator](/api-reference/10%20UI%20Widgets/dxValidator '/Documentation/ApiReference/UI_Widgets/dxValidator/') widget.
