If you are starting a project from scratch, use the [DevExtreme Angular Template](/concepts/40%20Angular%20Components/30%20Application%20Template/00%20Application%20Template.md '/concepts/40%20Angular%20Components/30%20Application%20Template/00%20Application%20Template.md '/Documentation/Guide/Angular_Components/Application_Template/''). It is a simple application with a navigation menu and several sample views in a responsive layout (see <a href="https://devexpress.github.io/devextreme-angular-template/#/home">live preview</a>).
...
2. Declare callback functions, event handlers, and binding properties in the application class. In this example, we declare the [onClick](/api-reference/10%20UI%20Components/dxButton/1%20Configuration/onClick.md '/api-reference/10%20UI%20Components '/Documentation/ApiReference/UI_Components/'dxButton/Configuration/#onClick') event handler in the `src\app\pages\home\home.component.ts` file:
...
For more information about the structure and contents of the DevExtreme Angular Template, refer to the [DevExtreme Application Template](/concepts/40%20Angular%20Components/30%20Application%20Template/00%20Application%20Template.md '/concepts/40%20Angular%20Components/30%20Application%20Template/00%20Application%20Template.md '/Documentation/Guide/Angular_Components/Application_Template/'') article.
