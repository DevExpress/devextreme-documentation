...
* A *computed signal* is derivative. It uses internal logic to process data from other signals.

You can respond to signals with **effects**. Effects are functions that run when one or more signals fire.

DevExtreme components are fully compatible with Angular Signals. If you want to integrate this capability into your application, you can examine a [sample DevExtreme application]( https://codesandbox.io/p/devbox/dx-signals-2m8hq8) with signals and effects.
