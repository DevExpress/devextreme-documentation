...
You can also use <a href="https://angular.io/guide/template-syntax#template-reference-variables--var-" target="_blank">template reference variables</a> to access a UI component instance in the markup:
