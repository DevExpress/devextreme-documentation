...
<a href="https://github.com/DevExpress/devextreme-examples/tree/24_1/universal-angular#universal-angular" target="_blank">This example</a> demonstrates DevExtreme components used in an Angular Universal application with server-side rendering.
