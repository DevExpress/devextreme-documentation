...
The application already contains the [DataGrid](https://js.devexpress.com/Demos/WidgetsGallery/Demo/DataGrid/Overview) and [Form](https://js.devexpress.com/Demos/WidgetsGallery/Demo/Form/Overview) UI components. You can find their configurations in the `src\pages\display-data\display-data.js` and `src\pages\profile\profile.js` files correspondingly.
