To manage the state of a controlled component, use the component's props. In the example below, the parent of the `TextBox` component determines the `value` property of the text box.
