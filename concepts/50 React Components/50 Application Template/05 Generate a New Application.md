...
[note] For more information about `devextreme-cli new react-app`, refer to the following help topic: [DevExtreme CLI - Create a New Application](/Documentation/Guide/Common/DevExtreme_CLI/#DevExtreme_Application/Create_a_New_Application).
