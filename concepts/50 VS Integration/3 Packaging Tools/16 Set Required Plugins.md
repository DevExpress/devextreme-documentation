...
Check the necessary plugins. They will be added to the project's **config.xml** file. Open this file and specify versions for the added plugins to make sure that they are compatible with the [used Cordova version](/concepts/50%20VS%20Integration/3%20Packaging%20Tools/17%20Set%20Cordova%20Version.md '/Documentation/Guide/VS_Integration/Packaging_Tools/#Set_Cordova_Version').
...
[note] We recommend specifying versions for the added Cordova plugins in the **config.xml** file to make sure that they are compatible with the [used Cordova version](/concepts/50%20VS%20Integration/3%20Packaging%20Tools/17%20Set%20Cordova%20Version.md '/Documentation/Guide/VS_Integration/Packaging_Tools/#Set_Cordova_Version').
