...
[note] DevExtreme components do not support `zoom` and `transform` CSS rules. Use a [Compact theme](/Documentation/Guide/Themes_and_Styles/Predefined_Themes/) to reduce all component sizes.