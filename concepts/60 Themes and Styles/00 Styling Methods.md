...
[note] DevExtreme components do not support `zoom` and `transform` CSS rules. To relatively reduce all component sizes, use a [Compact theme](/Documentation/Guide/Themes_and_Styles/Predefined_Themes/).