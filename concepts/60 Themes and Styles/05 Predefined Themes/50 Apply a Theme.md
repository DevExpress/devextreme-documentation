...
Include `dx.common.css` and a theme stylesheet in the `<head>` tag on your index page. You can use [local files](/concepts/Common/Distribution%20Channels/15%20ZIP%20Archive.md '/Documentation/Guide/Common/Distribution_Channels/ZIP_Archive/') or get the stylesheets [from CDN](/concepts/Common/Distribution%20Channels/05%20CDN '/Documentation/Guide/Common/Distribution_Channels/CDN/').
