...
- **jQuery**   
Include `dx.common.css` and a theme stylesheet in the `<head>` tag on your index page. You can use [local files](/Documentation/Guide/jQuery_Components/Add_DevExtreme_to_a_jQuery_Application/#Local_Files) or get the stylesheets [from CDN](/Documentation/Guide/jQuery_Components/Add_DevExtreme_to_a_jQuery_Application/#CDN_Files).
