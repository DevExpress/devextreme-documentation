...
Include `dx.common.css` and a theme stylesheet in the `<head>` tag on your index page. You can use [local files](/concepts/00%20Getting%20Started/01%20Installation/10%20Local%20Scripts.md '/Documentation/Guide/Getting_Started/Installation/Local_Scripts/') or get the stylesheets [from CDN](/concepts/00%20Getting%20Started/01%20Installation/05%20CDN%20Services '/Documentation/Guide/Getting_Started/Installation/CDN_Services/').
