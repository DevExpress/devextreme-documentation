...
[important] Color swatches should belong to the same theme as the main application theme (Generic, Generic Compact, Material, or Fluent). For example, if the main application theme is Material, you can use only the color swatches that are based on the Material theme.
...
* **<a href="https://github.com/DevExpress/devextreme-cli/blob/master/README.md" target="_blank">DevExtreme CLI</a>**        
    ...
    Refer to [DevExtreme CLI: ThemeBuilder](/concepts/Common/DevExtreme%20CLI/50%20ThemeBuilder/00%20ThemeBuilder.md '/Documentation/Guide/Common/DevExtreme_CLI/#ThemeBuilder') for more information about CLI commands and command line arguments.
