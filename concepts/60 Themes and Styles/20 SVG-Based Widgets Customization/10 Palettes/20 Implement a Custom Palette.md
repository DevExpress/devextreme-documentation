...
The custom palette should be registered using the [registerPalette(paletteName, palette)](/api-reference/50%20Common/utils/viz/3%20Methods/registerPalette(paletteName_palette).md '/Documentation/ApiReference/Common/utils/viz/Methods/#registerPalettepaletteName_palette') method:
