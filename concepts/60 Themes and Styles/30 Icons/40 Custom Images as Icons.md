...
`customicon` here is the icon's name that you should [assign to the UI component's **icon** option](/concepts/60%20Themes%20and%20Styles/30%20Icons/20%20Icons%20in%20DevExtreme%20UI%20Components.md '/Documentation/Guide/Themes_and_Styles/Icons/#Icons_in_DevExtreme_UI_Components').
