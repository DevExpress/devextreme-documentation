In addition to font icons, DevExtreme supplies the same icons in the SVG format. You can find SVG icons in the [DevExtreme repository](https://github.com/DevExpress/DevExtreme/tree/24_2/packages/devextreme-scss/images/icons) on GitHub.
