In addition to font icons, DevExtreme supplies the same icons in the SVG format. You can find SVG icons in the <a href="https://github.com/DevExpress/DevExtreme/tree/25_2/packages/devextreme/images/icons" target="_blank">DevExtreme repository</a> on GitHub.
...
[important] The SVG format can contain executable code that might be malicious. We recommend that you use SVG icons from trusted sources only.
