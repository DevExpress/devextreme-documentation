In addition to font icons, DevExtreme supplies the same icons in the SVG format. You can find SVG icons in the <a href="https://github.com/DevExpress/DevExtreme/tree/21_2/images/icons" target="_blank">DevExtreme repository</a> on GitHub.
