...
[note] The **getDataSource()**.[load()](/Documentation/ApiReference/Data_Layer/DataSource/Methods/#load) method re-renderes the component. To avoid this behavior, use **getDataSource()**.[store()](/Documentation/ApiReference/Data_Layer/DataSource/Methods/#store).[load()](/Documentation/ApiReference/Data_Layer/ArrayStore/Methods/#load) instead.
