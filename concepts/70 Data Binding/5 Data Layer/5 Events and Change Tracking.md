...
To attach a handler for a certain event to a DataSource or Data Store, use the corresponding configuration property. The options that take on event handling functions have names starting with *on*.
