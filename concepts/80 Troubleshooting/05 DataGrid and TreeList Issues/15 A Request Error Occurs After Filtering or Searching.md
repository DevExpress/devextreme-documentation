...
1. Obtain a URL link generated by the problematic data query in the browser [network tab](/concepts/80%20Troubleshooting/50%20A%20Drop-Down%20Editor%20Does%20Not%20Show%20Data/15%20AspNet.Data.createStore()%20Method%20Specifics.md '/Documentation/Guide/Troubleshooting/A_Drop-Down_Editor_Does_Not_Show_Data/#AspNetDatacreateStore_Method_Specifics'). Paste the URL in a new browser tab.
...
- Selection does not work if [selection.deferred](/api-reference/10%20UI%20Components/dxDataGrid/1%20Configuration/selection/deferred.md '/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/selection/#deferred') is `true`.
