...
For DevExtreme-specific instructions, the [DevExpress/agent-skills](https://github.com/DevExpress/agent-skills) repository includes a dedicated [plugins/devextreme/instructions](https://github.com/DevExpress/agent-skills/tree/main/plugins/devextreme/instructions) folder. Copy the instruction files into your project's `.github/instructions/` folder (VS Code) or the equivalent location for your IDE.