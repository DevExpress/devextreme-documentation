...
![Sample application example](/images/MUI/full-page.png)
...
Open `App.tsx`. There, we can use the `styled-components` library and MUI's built-in theme manager to manage the visual look of our page.
...
## Example 2: MUI components inside DevExtreme components
