You can export DevExtreme components in PDF (such as [DataGrid](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/export/), [Gantt](/Documentation/Guide/UI_Components/Gantt/Export_Data/), [Chart](/Documentation/ApiReference/UI_Components/dxChart/Configuration/export/) and other data visualization components). If you need a more advanced solution, refer to the [DevExpress Office File API](https://www.devexpress.com/products/net/office-file-api/pdf/) library.
