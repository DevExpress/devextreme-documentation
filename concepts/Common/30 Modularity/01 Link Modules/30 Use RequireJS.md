...
1. Use the [RequireJS conversion tool](https://requirejs.org/docs/commonjs.html#autoconversion) to convert the DevExtreme modules from CommonJS to AMD and save them in the **devextreme_amd** directory:
