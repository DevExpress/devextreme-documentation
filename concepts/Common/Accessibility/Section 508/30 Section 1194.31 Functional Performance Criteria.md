<table class="simple-table">
    ...
    <tr>
        ...
        <td>Supports</td>
        <td>Using DevExtreme widgets in combination with Assistive Technologies, a user can modify an editor’s entered value, be informed when this value changes, and obtain information about the editor’s state and possible input values.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>DevExtreme widgets do not have audio features.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>DevExtreme widgets support forward interior element navigation using the Tab key if the <b>tabIndex</b> option is specified. When a widget is focussed, its internal elements can be operated using the keyboard.</td>
    </tr>
</table>