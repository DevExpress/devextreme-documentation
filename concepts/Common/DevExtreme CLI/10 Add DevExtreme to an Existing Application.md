...
- References the `dx.fluent.blue.light.css` [DevExtreme stylesheet](/concepts/60%20Themes%20and%20Styles/05%20Predefined%20Themes/00%20Predefined%20Themes.md '/Documentation/Guide/Themes_and_Styles/Predefined_Themes/') in `angular.json`.
...
- Imports the `dx.fluent.blue.light.css` [DevExtreme stylesheet](/concepts/60%20Themes%20and%20Styles/05%20Predefined%20Themes/00%20Predefined%20Themes.md '/Documentation/Guide/Themes_and_Styles/Predefined_Themes/') in `src/main.js`.
...
- Imports the `dx.fluent.blue.light.css` [DevExtreme stylesheet](/concepts/60%20Themes%20and%20Styles/05%20Predefined%20Themes/00%20Predefined%20Themes.md '/Documentation/Guide/Themes_and_Styles/Predefined_Themes/') in `src/App.js`.
