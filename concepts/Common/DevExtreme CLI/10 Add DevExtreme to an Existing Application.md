...
- References the `dx.light.css` [DevExtreme stylesheet](/concepts/60%20Themes%20and%20Styles/05%20Predefined%20Themes/00%20Predefined%20Themes.md '/Documentation/Guide/Themes_and_Styles/Predefined_Themes/') in `angular.json`.
...
- Imports the `dx.light.css` [DevExtreme stylesheet](/concepts/60%20Themes%20and%20Styles/05%20Predefined%20Themes/00%20Predefined%20Themes.md '/Documentation/Guide/Themes_and_Styles/Predefined_Themes/') in `src/main.js`.
...
The `add devextreme-react` command supports React apps created with various build tools, such as Vite and Next.js. DevExtreme CLI supports Next.js apps created with different option combinations, such as with or without a `src` folder, using TypeScript or JavaScript, with or without App Routing, and more.
