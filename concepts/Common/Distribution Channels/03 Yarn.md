...
Install the latest stable version:
    ...
    yarn add devextreme-angular@22.2 --exact // to use DevExtreme with Angular
    yarn add devextreme-vue@22.2 --exact // to use DevExtreme with Vue
    yarn add devextreme-react@22.2 --exact  // to use DevExtreme with React
...
Install the latest <a href="https://github.com/DevExpress/DevExtreme/releases" target="_blank">published version</a>. It can be stable or pre-release. Pre-release versions contain hotfixes and new features for early testing.
    ...
    yarn add devextreme-angular@22.2-next --exact // to use DevExtreme with Angular
    yarn add devextreme-vue@22.2-next --exact // to use DevExtreme with Vue
    yarn add devextreme-react@22.2-next --exact  // to use DevExtreme with React
