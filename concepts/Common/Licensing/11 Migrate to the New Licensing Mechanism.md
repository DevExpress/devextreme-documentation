...
The `devextreme-license` CLI reads your registered DevExpress key and generates a DevExtreme-compatible runtime key. Pass the runtime key to the [DevExpress.config(GlobalConfig)](/api-reference/50%20Common/utils/config().md '/Documentation/ApiReference/Common/Utils/#config') method.
