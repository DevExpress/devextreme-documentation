...
When creating the first component, DevExtreme checks the license key specified in the `config()` method. If license key verification is successful, you will not see any additional license-related messages within the browser console or on-screen.
