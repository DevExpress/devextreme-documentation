...
[note] To learn more about licensing in ASP.NET Core/MVC, refer to the following article: [Convert a Trial Version to a Licensed Version](https://docs.devexpress.com/GeneralInformation/403579/trial-register/convert-a-trial-version-to-a-licensed-version).
