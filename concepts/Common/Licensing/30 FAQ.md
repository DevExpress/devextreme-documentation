...
A: No, revoking keys is not possible due to the offline nature of the key validation process. Once issued for a DevExtreme version (e.g., 26.1), a key will remain valid indefinitely for all minor updates and security issues.
...
- [DevExpress ASP.NET Core](https://demos.devexpress.com/aspnetcore/) + [DevExtreme jQuery](https://js.devexpress.com/jQuery/)

- [DevExpress ASP.NET MVC](https://demos.devexpress.com/ASPNetMvc/) + [DevExtreme jQuery](https://js.devexpress.com/jQuery/)
...
[note] For more information about licensing in ASP.NET Core/MVC, refer to the following article: [ASP.NET Core and ASP.NET MVC Projects](/Documentation/Guide/Common/Licensing/#Validation/ASPNET_Core_and_ASPNET_MVC_Projects).
