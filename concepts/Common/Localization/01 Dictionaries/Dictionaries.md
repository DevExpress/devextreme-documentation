...
[note] Certain messages may not be translated in community-sourced dictionaries. To translate these messages, refer to [Override Strings in a Dictionary]({currentpath}/Override_Strings_in_a_Dictionary). To contribute your translations to the DevExtreme repository, refer to our [Contribution Guide](https://github.com/DevExpress/DevExtreme/blob/25_2/CONTRIBUTING.md).
