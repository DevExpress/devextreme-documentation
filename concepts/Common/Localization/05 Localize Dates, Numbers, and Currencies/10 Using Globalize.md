...
[note]If you apply [CSP rules](/Documentation/Guide/Common/Security_Considerations/#Content_Security_Policy), we do not recommend you to use the Globalize approach. Use the [Intl](/Documentation/Guide/Common/Localization/#Localize_Dates_Numbers_and_Currencies/Using_Intl) approach instead.
