...
See examples of using jspm with <a href="https://github.com/DevExpress/devextreme-examples/tree/20_2/jspm-jquery" target="_blank">jQuery</a> on GitHub. The **index.js** and **index.html** files contain the main code. 
