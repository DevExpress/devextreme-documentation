...
You can see examples on how to use RequireJS with jQuery on GitHub. The **index.html** file contains the main code. jQuery components require additional [integration module](/concepts/Common/Modularity/02%20DevExtreme%20Modules%20Structure/integration/jquery.md '/Documentation/Guide/Common/Modularity/DevExtreme_Modules_Structure/#integration/jquery').
