Exposes an [object](/api-reference/50%20Common/utils/ui/themes '/Documentation/ApiReference/Common/Utils/ui/themes/') that serves as a namespace for the methods that work with DevExtreme CSS Themes.
