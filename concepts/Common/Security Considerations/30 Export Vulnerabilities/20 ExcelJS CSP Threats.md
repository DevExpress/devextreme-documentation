The DataGrid and PivotGrid components use the [ExcelJS](https://github.com/exceljs/exceljs) third-party library to export data to Excel. If you implement export functionality and apply [CSP rules](/Documentation/Guide/Common/Security_Considerations/#Content_Security_Policy/Common_CSP_Directives), you should include the following initialization code before the line that loads ExcelJS sources: `window.regeneratorRuntime = null;` 
