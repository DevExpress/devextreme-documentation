You can find the file with TypeScript definitions for DevExtreme in the DevExtreme zip archive or in the folder where you have installed DevExtreme, which is **C:\Program Files (x86)\DevExpress 20.2\DevExtreme\Sources\Lib\ts** by default. Add this file to your project. Then, reference this and jQuery TypeScript definition file in your *.ts*-file.
...
#####See Also#####
- [Configure a UI component Using TypeScript](/concepts/Common/TypeScript%20Support/05%20Configure%20a%20Widget.md '/Documentation/Guide/Common/TypeScript_Support/Configure_a_Widget/')
