...
A UI component's **format** property is compatible with the `options` parameter of the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat#Parameters" target="_blank">Intl.NumberFormat</a> and <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#Parameters" target="_blank">Intl.DateTimeFormat</a>. To apply an Intl format, specify the `options` parameter's fields in the **format** property:
