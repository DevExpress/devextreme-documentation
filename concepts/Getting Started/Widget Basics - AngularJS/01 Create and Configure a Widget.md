...
Any DevExtreme directive should be associated with a `<div>` HTML element, which plays the role of a container for the UI component. For example, the following code creates a [Chart](/api-reference/10%20UI%20Components/dxChart '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart'/') UI component in a `<div>` container.
...
#####See Also#####
- **API Reference**.**WidgetName**.**Configuration**, for example, **API Reference**.[Chart](/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart').[Configuration](/api-reference/10%20UI%20Components/dxChart '/api-reference/10%20UI%20Components/dxChart '/Documentation/ApiReference/UI_Components/dxChart'/'Configuration/)
